...
urlAtIndex_effectiveRange nsAttributedString  location effectiveRange =
    sendMsg nsAttributedString (mkSelector "URLAtIndex:effectiveRange:") (retPtr retVoid) [argCULong location, argPtr effectiveRange] >>= retainedObject . castPtr
...
lineBreakBeforeIndex_withinRange nsAttributedString  location aRange =
    sendMsg nsAttributedString (mkSelector "lineBreakBeforeIndex:withinRange:") retCULong [argCULong location, argNSRange aRange]
...
lineBreakByHyphenatingBeforeIndex_withinRange nsAttributedString  location aRange =
    sendMsg nsAttributedString (mkSelector "lineBreakByHyphenatingBeforeIndex:withinRange:") retCULong [argCULong location, argNSRange aRange]
...
doubleClickAtIndex nsAttributedString  location =
    sendMsgStret nsAttributedString (mkSelector "doubleClickAtIndex:") retNSRange [argCULong location]
...
rangeOfTextBlock_atIndex nsAttributedString  block location =
  withObjCPtr block $ \raw_block ->
      sendMsgStret nsAttributedString (mkSelector "rangeOfTextBlock:atIndex:") retNSRange [argPtr (castPtr raw_block :: Ptr ()), argCULong location]
...
rangeOfTextTable_atIndex nsAttributedString  table location =
  withObjCPtr table $ \raw_table ->
      sendMsgStret nsAttributedString (mkSelector "rangeOfTextTable:atIndex:") retNSRange [argPtr (castPtr raw_table :: Ptr ()), argCULong location]
...
rangeOfTextList_atIndex nsAttributedString  list location =
  withObjCPtr list $ \raw_list ->
      sendMsgStret nsAttributedString (mkSelector "rangeOfTextList:atIndex:") retNSRange [argPtr (castPtr raw_list :: Ptr ()), argCULong location]
