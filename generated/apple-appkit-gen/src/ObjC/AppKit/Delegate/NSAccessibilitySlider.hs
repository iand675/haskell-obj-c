...
-- | Generated delegate overrides for @\@protocol NSAccessibilitySlider@.
--
-- Usage:
--
-- @
-- delegate <- newNSAccessibilitySlider defaultNSAccessibilitySliderOverrides
--   { ... = Just $ \\arg0 -> ...
--   }
-- @
module ObjC.AppKit.Delegate.NSAccessibilitySlider
  ( NSAccessibilitySliderOverrides(..)
  , defaultNSAccessibilitySliderOverrides
  , newNSAccessibilitySlider
  ) where
...
-- | Overrides record for @\@protocol NSAccessibilitySlider@.
--
-- Each field corresponds to a protocol method.  'Nothing' means the
-- method is not implemented (the object will not respond to that
-- selector).  'Just' provides the Haskell implementation.
data NSAccessibilitySliderOverrides = NSAccessibilitySliderOverrides
...
defaultNSAccessibilitySliderOverrides :: NSAccessibilitySliderOverrides
defaultNSAccessibilitySliderOverrides = NSAccessibilitySliderOverrides
...
{-# NOINLINE nsAccessibilitySliderDelegateClass #-}
nsAccessibilitySliderDelegateClass :: Class
nsAccessibilitySliderDelegateClass = unsafePerformIO $ do
  superCls <- getRequiredClass "NSObject"
  cls <- withCString "HsNSAccessibilitySlider" $ \n ->
  ...
  stub_0 <- wrap_at $ \self _cmd -> do
    sp <- readHsData self
    rec_ <- deRefStablePtr sp :: IO NSAccessibilitySliderOverrides
  ...
  stub_1 <- wrap_at $ \self _cmd -> do
    ...
    case _accessibilityValue rec_ of
      ...
      Just f -> do
        r <- f 
        pure (castPtr (unRawId r) :: Ptr ObjCObject)
  addObjCMethod cls "accessibilityValue" "@@:" stub_1
  ...
  addObjCMethod cls "accessibilityPerformIncrement" "B@:" stub_2
  ...
  stub_3 <- wrap_B $ \self _cmd -> do
    ...
    case _accessibilityPerformDecrement rec_ of
      ...
      Just f -> do
        r <- f 
        pure (if r then 1 else 0)
  addObjCMethod cls "accessibilityPerformDecrement" "B@:" stub_3
...
newNSAccessibilitySlider :: NSAccessibilitySliderOverrides -> IO RawId
newNSAccessibilitySlider overrides = do
  inst <- class_createInstance nsAccessibilitySliderDelegateClass 0
