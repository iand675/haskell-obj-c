...
bezierPathWithRoundedRect_xRadius_yRadius rect xRadius yRadius =
  do
    cls' <- getRequiredClass "NSBezierPath"
    sendClassMsg cls' (mkSelector "bezierPathWithRoundedRect:xRadius:yRadius:") (retPtr retVoid) [argNSRect rect, argCDouble xRadius, argCDouble yRadius] >>= retainedObject . castPtr
...
setLineDash_count_phase nsBezierPath  pattern_ count phase =
    sendMsg nsBezierPath (mkSelector "setLineDash:count:phase:") retVoid [argPtr (unConst pattern_), argCLong count, argCDouble phase]
...
elementAtIndex_associatedPoints nsBezierPath  index points =
    fmap (coerce :: CULong -> NSBezierPathElement) $ sendMsg nsBezierPath (mkSelector "elementAtIndex:associatedPoints:") retCULong [argCLong index, argPtr points]

-- | @- elementAtIndex:@
elementAtIndex :: IsNSBezierPath nsBezierPath => nsBezierPath -> CLong -> IO NSBezierPathElement
elementAtIndex nsBezierPath  index =
    fmap (coerce :: CULong -> NSBezierPathElement) $ sendMsg nsBezierPath (mkSelector "elementAtIndex:") retCULong [argCLong index]
...
setAssociatedPoints_atIndex nsBezierPath  points index =
    sendMsg nsBezierPath (mkSelector "setAssociatedPoints:atIndex:") retVoid [argPtr points, argCLong index]
...
appendBezierPathWithPoints_count nsBezierPath  points count =
    sendMsg nsBezierPath (mkSelector "appendBezierPathWithPoints:count:") retVoid [argPtr points, argCLong count]
...
appendBezierPathWithArcWithCenter_radius_startAngle_endAngle_clockwise nsBezierPath  center radius startAngle endAngle clockwise =
    sendMsg nsBezierPath (mkSelector "appendBezierPathWithArcWithCenter:radius:startAngle:endAngle:clockwise:") retVoid [argNSPoint center, argCDouble radius, argCDouble startAngle, argCDouble endAngle, argCULong (if clockwise then 1 else 0)]
...
appendBezierPathWithArcWithCenter_radius_startAngle_endAngle nsBezierPath  center radius startAngle endAngle =
    sendMsg nsBezierPath (mkSelector "appendBezierPathWithArcWithCenter:radius:startAngle:endAngle:") retVoid [argNSPoint center, argCDouble radius, argCDouble startAngle, argCDouble endAngle]
...
appendBezierPathWithArcFromPoint_toPoint_radius nsBezierPath  point1 point2 radius =
    sendMsg nsBezierPath (mkSelector "appendBezierPathWithArcFromPoint:toPoint:radius:") retVoid [argNSPoint point1, argNSPoint point2, argCDouble radius]
...
appendBezierPathWithRoundedRect_xRadius_yRadius nsBezierPath  rect xRadius yRadius =
    sendMsg nsBezierPath (mkSelector "appendBezierPathWithRoundedRect:xRadius:yRadius:") retVoid [argNSRect rect, argCDouble xRadius, argCDouble yRadius]
...
setDefaultMiterLimit value =
  do
    cls' <- getRequiredClass "NSBezierPath"
    sendClassMsg cls' (mkSelector "setDefaultMiterLimit:") retVoid [argCDouble value]
...
setDefaultFlatness value =
  do
    cls' <- getRequiredClass "NSBezierPath"
    sendClassMsg cls' (mkSelector "setDefaultFlatness:") retVoid [argCDouble value]
...
setDefaultLineWidth value =
  do
    cls' <- getRequiredClass "NSBezierPath"
    sendClassMsg cls' (mkSelector "setDefaultLineWidth:") retVoid [argCDouble value]
...
setLineWidth nsBezierPath  value =
    sendMsg nsBezierPath (mkSelector "setLineWidth:") retVoid [argCDouble value]
...
setMiterLimit nsBezierPath  value =
    sendMsg nsBezierPath (mkSelector "setMiterLimit:") retVoid [argCDouble value]
...
setFlatness nsBezierPath  value =
    sendMsg nsBezierPath (mkSelector "setFlatness:") retVoid [argCDouble value]
