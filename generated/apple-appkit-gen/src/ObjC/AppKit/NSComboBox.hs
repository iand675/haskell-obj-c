...
insertItemWithObjectValue_atIndex nsComboBox  object index =
    sendMsg nsComboBox (mkSelector "insertItemWithObjectValue:atIndex:") retVoid [argPtr (castPtr (unRawId object) :: Ptr ()), argCLong index]
...
removeItemAtIndex nsComboBox  index =
    sendMsg nsComboBox (mkSelector "removeItemAtIndex:") retVoid [argCLong index]
...
itemObjectValueAtIndex nsComboBox  index =
    fmap (RawId . castPtr) $ sendMsg nsComboBox (mkSelector "itemObjectValueAtIndex:") (retPtr retVoid) [argCLong index]
...
setItemHeight nsComboBox  value =
    sendMsg nsComboBox (mkSelector "setItemHeight:") retVoid [argCDouble value]
...
setNumberOfVisibleItems nsComboBox  value =
    sendMsg nsComboBox (mkSelector "setNumberOfVisibleItems:") retVoid [argCLong value]
