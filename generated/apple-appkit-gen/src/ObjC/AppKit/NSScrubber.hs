...
moveItemAtIndex_toIndex nsScrubber  oldIndex newIndex =
    sendMsg nsScrubber (mkSelector "moveItemAtIndex:toIndex:") retVoid [argCLong oldIndex, argCLong newIndex]
...
scrollItemAtIndex_toAlignment nsScrubber  index alignment =
    sendMsg nsScrubber (mkSelector "scrollItemAtIndex:toAlignment:") retVoid [argCLong index, argCLong (coerce alignment)]
...
itemViewForItemAtIndex nsScrubber  index =
    sendMsg nsScrubber (mkSelector "itemViewForItemAtIndex:") (retPtr retVoid) [argCLong index] >>= retainedObject . castPtr
...
setSelectedIndex nsScrubber  value =
    sendMsg nsScrubber (mkSelector "setSelectedIndex:") retVoid [argCLong value]
