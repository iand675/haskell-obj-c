...
selectSegmentWithTag nsSegmentedControl  tag =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedControl (mkSelector "selectSegmentWithTag:") retCULong [argCLong tag]
...
setWidth_forSegment nsSegmentedControl  width segment =
    sendMsg nsSegmentedControl (mkSelector "setWidth:forSegment:") retVoid [argCDouble width, argCLong segment]
...
widthForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "widthForSegment:") retCDouble [argCLong segment]
...
setImage_forSegment nsSegmentedControl  image segment =
  withObjCPtr image $ \raw_image ->
      sendMsg nsSegmentedControl (mkSelector "setImage:forSegment:") retVoid [argPtr (castPtr raw_image :: Ptr ()), argCLong segment]
...
imageForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "imageForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setImageScaling_forSegment nsSegmentedControl  scaling segment =
    sendMsg nsSegmentedControl (mkSelector "setImageScaling:forSegment:") retVoid [argCULong (coerce scaling), argCLong segment]
...
imageScalingForSegment nsSegmentedControl  segment =
    fmap (coerce :: CULong -> NSImageScaling) $ sendMsg nsSegmentedControl (mkSelector "imageScalingForSegment:") retCULong [argCLong segment]
...
setLabel_forSegment nsSegmentedControl  label segment =
  withObjCPtr label $ \raw_label ->
      sendMsg nsSegmentedControl (mkSelector "setLabel:forSegment:") retVoid [argPtr (castPtr raw_label :: Ptr ()), argCLong segment]
...
labelForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "labelForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setMenu_forSegment nsSegmentedControl  menu segment =
  withObjCPtr menu $ \raw_menu ->
      sendMsg nsSegmentedControl (mkSelector "setMenu:forSegment:") retVoid [argPtr (castPtr raw_menu :: Ptr ()), argCLong segment]
...
menuForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "menuForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setSelected_forSegment nsSegmentedControl  selected segment =
    sendMsg nsSegmentedControl (mkSelector "setSelected:forSegment:") retVoid [argCULong (if selected then 1 else 0), argCLong segment]
...
isSelectedForSegment nsSegmentedControl  segment =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedControl (mkSelector "isSelectedForSegment:") retCULong [argCLong segment]
...
setEnabled_forSegment nsSegmentedControl  enabled segment =
    sendMsg nsSegmentedControl (mkSelector "setEnabled:forSegment:") retVoid [argCULong (if enabled then 1 else 0), argCLong segment]
...
isEnabledForSegment nsSegmentedControl  segment =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedControl (mkSelector "isEnabledForSegment:") retCULong [argCLong segment]
...
setToolTip_forSegment nsSegmentedControl  toolTip segment =
  withObjCPtr toolTip $ \raw_toolTip ->
      sendMsg nsSegmentedControl (mkSelector "setToolTip:forSegment:") retVoid [argPtr (castPtr raw_toolTip :: Ptr ()), argCLong segment]
...
toolTipForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "toolTipForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setTag_forSegment nsSegmentedControl  tag segment =
    sendMsg nsSegmentedControl (mkSelector "setTag:forSegment:") retVoid [argCLong tag, argCLong segment]
...
tagForSegment nsSegmentedControl  segment =
    sendMsg nsSegmentedControl (mkSelector "tagForSegment:") retCLong [argCLong segment]
...
setShowsMenuIndicator_forSegment nsSegmentedControl  showsMenuIndicator segment =
    sendMsg nsSegmentedControl (mkSelector "setShowsMenuIndicator:forSegment:") retVoid [argCULong (if showsMenuIndicator then 1 else 0), argCLong segment]
...
showsMenuIndicatorForSegment nsSegmentedControl  segment =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedControl (mkSelector "showsMenuIndicatorForSegment:") retCULong [argCLong segment]
...
setAlignment_forSegment nsSegmentedControl  alignment segment =
    sendMsg nsSegmentedControl (mkSelector "setAlignment:forSegment:") retVoid [argCLong (coerce alignment), argCLong segment]
...
alignmentForSegment nsSegmentedControl  segment =
    fmap (coerce :: CLong -> NSTextAlignment) $ sendMsg nsSegmentedControl (mkSelector "alignmentForSegment:") retCLong [argCLong segment]
...
setSegmentCount nsSegmentedControl  value =
    sendMsg nsSegmentedControl (mkSelector "setSegmentCount:") retVoid [argCLong value]
...
setSelectedSegment nsSegmentedControl  value =
    sendMsg nsSegmentedControl (mkSelector "setSelectedSegment:") retVoid [argCLong value]
