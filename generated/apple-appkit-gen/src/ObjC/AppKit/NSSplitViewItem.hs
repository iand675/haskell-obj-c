...
insertTopAlignedAccessoryViewController_atIndex nsSplitViewItem  childViewController index =
  withObjCPtr childViewController $ \raw_childViewController ->
      sendMsg nsSplitViewItem (mkSelector "insertTopAlignedAccessoryViewController:atIndex:") retVoid [argPtr (castPtr raw_childViewController :: Ptr ()), argCLong index]
...
removeTopAlignedAccessoryViewControllerAtIndex nsSplitViewItem  index =
    sendMsg nsSplitViewItem (mkSelector "removeTopAlignedAccessoryViewControllerAtIndex:") retVoid [argCLong index]
...
insertBottomAlignedAccessoryViewController_atIndex nsSplitViewItem  childViewController index =
  withObjCPtr childViewController $ \raw_childViewController ->
      sendMsg nsSplitViewItem (mkSelector "insertBottomAlignedAccessoryViewController:atIndex:") retVoid [argPtr (castPtr raw_childViewController :: Ptr ()), argCLong index]
...
removeBottomAlignedAccessoryViewControllerAtIndex nsSplitViewItem  index =
    sendMsg nsSplitViewItem (mkSelector "removeBottomAlignedAccessoryViewControllerAtIndex:") retVoid [argCLong index]
...
setMinimumThickness nsSplitViewItem  value =
    sendMsg nsSplitViewItem (mkSelector "setMinimumThickness:") retVoid [argCDouble value]
...
setMaximumThickness nsSplitViewItem  value =
    sendMsg nsSplitViewItem (mkSelector "setMaximumThickness:") retVoid [argCDouble value]
...
setPreferredThicknessFraction nsSplitViewItem  value =
    sendMsg nsSplitViewItem (mkSelector "setPreferredThicknessFraction:") retVoid [argCDouble value]
...
setHoldingPriority nsSplitViewItem  value =
    sendMsg nsSplitViewItem (mkSelector "setHoldingPriority:") retVoid [argCFloat value]
...
setAutomaticMaximumThickness nsSplitViewItem  value =
    sendMsg nsSplitViewItem (mkSelector "setAutomaticMaximumThickness:") retVoid [argCDouble value]
