...
textTabForGlyphLocation_writingDirection_maxLocation nsTypesetter  glyphLocation direction maxLocation =
    sendMsg nsTypesetter (mkSelector "textTabForGlyphLocation:writingDirection:maxLocation:") (retPtr retVoid) [argCDouble glyphLocation, argCLong (coerce direction), argCDouble maxLocation] >>= retainedObject . castPtr
...
beginLineWithGlyphAtIndex nsTypesetter  glyphIndex =
    sendMsg nsTypesetter (mkSelector "beginLineWithGlyphAtIndex:") retVoid [argCULong glyphIndex]
...
lineSpacingAfterGlyphAtIndex_withProposedLineFragmentRect nsTypesetter  glyphIndex rect =
    sendMsg nsTypesetter (mkSelector "lineSpacingAfterGlyphAtIndex:withProposedLineFragmentRect:") retCDouble [argCULong glyphIndex, argNSRect rect]
...
paragraphSpacingBeforeGlyphAtIndex_withProposedLineFragmentRect nsTypesetter  glyphIndex rect =
    sendMsg nsTypesetter (mkSelector "paragraphSpacingBeforeGlyphAtIndex:withProposedLineFragmentRect:") retCDouble [argCULong glyphIndex, argNSRect rect]
...
paragraphSpacingAfterGlyphAtIndex_withProposedLineFragmentRect nsTypesetter  glyphIndex rect =
    sendMsg nsTypesetter (mkSelector "paragraphSpacingAfterGlyphAtIndex:withProposedLineFragmentRect:") retCDouble [argCULong glyphIndex, argNSRect rect]
...
layoutGlyphsInLayoutManager_startingAtGlyphIndex_maxNumberOfLineFragments_nextGlyphIndex nsTypesetter  layoutManager startGlyphIndex maxNumLines nextGlyph =
  withObjCPtr layoutManager $ \raw_layoutManager ->
      sendMsg nsTypesetter (mkSelector "layoutGlyphsInLayoutManager:startingAtGlyphIndex:maxNumberOfLineFragments:nextGlyphIndex:") retVoid [argPtr (castPtr raw_layoutManager :: Ptr ()), argCULong startGlyphIndex, argCULong maxNumLines, argPtr nextGlyph]
...
layoutCharactersInRange_forLayoutManager_maximumNumberOfLineFragments nsTypesetter  characterRange layoutManager maxNumLines =
  withObjCPtr layoutManager $ \raw_layoutManager ->
      sendMsgStret nsTypesetter (mkSelector "layoutCharactersInRange:forLayoutManager:maximumNumberOfLineFragments:") retNSRange [argNSRange characterRange, argPtr (castPtr raw_layoutManager :: Ptr ()), argCULong maxNumLines]
...
printingAdjustmentInLayoutManager_forNominallySpacedGlyphRange_packedGlyphs_count layoutMgr nominallySpacedGlyphsRange packedGlyphs packedGlyphsCount =
  do
    ...
    withObjCPtr layoutMgr $ \raw_layoutMgr ->
      sendClassMsgStret cls' (mkSelector "printingAdjustmentInLayoutManager:forNominallySpacedGlyphRange:packedGlyphs:count:") retNSSize [argPtr (castPtr raw_layoutMgr :: Ptr ()), argNSRange nominallySpacedGlyphsRange, argPtr (unConst packedGlyphs), argCULong packedGlyphsCount]
...
baselineOffsetInLayoutManager_glyphIndex nsTypesetter  layoutMgr glyphIndex =
  withObjCPtr layoutMgr $ \raw_layoutMgr ->
      sendMsg nsTypesetter (mkSelector "baselineOffsetInLayoutManager:glyphIndex:") retCDouble [argPtr (castPtr raw_layoutMgr :: Ptr ()), argCULong glyphIndex]
...
insertGlyph_atGlyphIndex_characterIndex nsTypesetter  glyph glyphIndex characterIndex =
    sendMsg nsTypesetter (mkSelector "insertGlyph:atGlyphIndex:characterIndex:") retVoid [argCUInt glyph, argCULong glyphIndex, argCULong characterIndex]
...
setLineFragmentRect_forGlyphRange_usedRect_baselineOffset nsTypesetter  fragmentRect glyphRange usedRect baselineOffset =
    sendMsg nsTypesetter (mkSelector "setLineFragmentRect:forGlyphRange:usedRect:baselineOffset:") retVoid [argNSRect fragmentRect, argNSRange glyphRange, argNSRect usedRect, argCDouble baselineOffset]
...
shouldBreakLineByWordBeforeCharacterAtIndex nsTypesetter  charIndex =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsTypesetter (mkSelector "shouldBreakLineByWordBeforeCharacterAtIndex:") retCULong [argCULong charIndex]
...
shouldBreakLineByHyphenatingBeforeCharacterAtIndex nsTypesetter  charIndex =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsTypesetter (mkSelector "shouldBreakLineByHyphenatingBeforeCharacterAtIndex:") retCULong [argCULong charIndex]
...
hyphenationFactorForGlyphAtIndex nsTypesetter  glyphIndex =
    sendMsg nsTypesetter (mkSelector "hyphenationFactorForGlyphAtIndex:") retCFloat [argCULong glyphIndex]
...
hyphenCharacterForGlyphAtIndex nsTypesetter  glyphIndex =
    sendMsg nsTypesetter (mkSelector "hyphenCharacterForGlyphAtIndex:") retCUInt [argCULong glyphIndex]
...
boundingBoxForControlGlyphAtIndex_forTextContainer_proposedLineFragment_glyphPosition_characterIndex nsTypesetter  glyphIndex textContainer proposedRect glyphPosition charIndex =
  withObjCPtr textContainer $ \raw_textContainer ->
      sendMsgStret nsTypesetter (mkSelector "boundingBoxForControlGlyphAtIndex:forTextContainer:proposedLineFragment:glyphPosition:characterIndex:") retNSRect [argCULong glyphIndex, argPtr (castPtr raw_textContainer :: Ptr ()), argNSRect proposedRect, argNSPoint glyphPosition, argCULong charIndex]
...
setHyphenationFactor nsTypesetter  value =
    sendMsg nsTypesetter (mkSelector "setHyphenationFactor:") retVoid [argCFloat value]
...
setLineFragmentPadding nsTypesetter  value =
    sendMsg nsTypesetter (mkSelector "setLineFragmentPadding:") retVoid [argCDouble value]
