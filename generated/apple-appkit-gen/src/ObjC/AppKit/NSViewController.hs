...
insertChildViewController_atIndex nsViewController  childViewController index =
  withObjCPtr childViewController $ \raw_childViewController ->
      sendMsg nsViewController (mkSelector "insertChildViewController:atIndex:") retVoid [argPtr (castPtr raw_childViewController :: Ptr ()), argCLong index]
...
removeChildViewControllerAtIndex nsViewController  index =
    sendMsg nsViewController (mkSelector "removeChildViewControllerAtIndex:") retVoid [argCLong index]
