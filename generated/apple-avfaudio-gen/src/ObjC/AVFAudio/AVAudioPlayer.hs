...
playAtTime avAudioPlayer  time =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg avAudioPlayer (mkSelector "playAtTime:") retCULong [argCDouble time]
...
setVolume_fadeDuration avAudioPlayer  volume duration =
    sendMsg avAudioPlayer (mkSelector "setVolume:fadeDuration:") retVoid [argCFloat volume, argCDouble duration]
...
peakPowerForChannel avAudioPlayer  channelNumber =
    sendMsg avAudioPlayer (mkSelector "peakPowerForChannel:") retCFloat [argCULong channelNumber]
...
averagePowerForChannel avAudioPlayer  channelNumber =
    sendMsg avAudioPlayer (mkSelector "averagePowerForChannel:") retCFloat [argCULong channelNumber]
...
setPan avAudioPlayer  value =
    sendMsg avAudioPlayer (mkSelector "setPan:") retVoid [argCFloat value]
...
setVolume avAudioPlayer  value =
    sendMsg avAudioPlayer (mkSelector "setVolume:") retVoid [argCFloat value]
...
setRate avAudioPlayer  value =
    sendMsg avAudioPlayer (mkSelector "setRate:") retVoid [argCFloat value]
...
setCurrentTime avAudioPlayer  value =
    sendMsg avAudioPlayer (mkSelector "setCurrentTime:") retVoid [argCDouble value]
...
setNumberOfLoops avAudioPlayer  value =
    sendMsg avAudioPlayer (mkSelector "setNumberOfLoops:") retVoid [argCLong value]
