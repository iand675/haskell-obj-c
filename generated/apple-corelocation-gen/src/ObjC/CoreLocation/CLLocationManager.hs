...
startMonitoringForRegion_desiredAccuracy clLocationManager  region accuracy =
  withObjCPtr region $ \raw_region ->
      sendMsg clLocationManager (mkSelector "startMonitoringForRegion:desiredAccuracy:") retVoid [argPtr (castPtr raw_region :: Ptr ()), argCDouble accuracy]
...
allowDeferredLocationUpdatesUntilTraveled_timeout clLocationManager  distance timeout =
    sendMsg clLocationManager (mkSelector "allowDeferredLocationUpdatesUntilTraveled:timeout:") retVoid [argCDouble distance, argCDouble timeout]
...
setDistanceFilter clLocationManager  value =
    sendMsg clLocationManager (mkSelector "setDistanceFilter:") retVoid [argCDouble value]
...
setDesiredAccuracy clLocationManager  value =
    sendMsg clLocationManager (mkSelector "setDesiredAccuracy:") retVoid [argCDouble value]
...
setHeadingFilter clLocationManager  value =
    sendMsg clLocationManager (mkSelector "setHeadingFilter:") retVoid [argCDouble value]
