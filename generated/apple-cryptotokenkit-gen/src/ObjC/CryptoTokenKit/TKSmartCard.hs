...
userInteractionForSecurePINVerificationWithPINFormat_APDU_PINByteOffset tkSmartCard  pinFormat apdu pinByteOffset =
  withObjCPtr pinFormat $ \raw_pinFormat ->
    withObjCPtr apdu $ \raw_apdu ->
        sendMsg tkSmartCard (mkSelector "userInteractionForSecurePINVerificationWithPINFormat:APDU:PINByteOffset:") (retPtr retVoid) [argPtr (castPtr raw_pinFormat :: Ptr ()), argPtr (castPtr raw_apdu :: Ptr ()), argCLong pinByteOffset] >>= retainedObject . castPtr
...
userInteractionForSecurePINChangeWithPINFormat_APDU_currentPINByteOffset_newPINByteOffset tkSmartCard  pinFormat apdu currentPINByteOffset newPINByteOffset =
  withObjCPtr pinFormat $ \raw_pinFormat ->
    withObjCPtr apdu $ \raw_apdu ->
        sendMsg tkSmartCard (mkSelector "userInteractionForSecurePINChangeWithPINFormat:APDU:currentPINByteOffset:newPINByteOffset:") (retPtr retVoid) [argPtr (castPtr raw_pinFormat :: Ptr ()), argPtr (castPtr raw_apdu :: Ptr ()), argCLong currentPINByteOffset, argCLong newPINByteOffset] >>= retainedObject . castPtr
...
sendIns_p1_p2_data_le_reply tkSmartCard  ins p1 p2 requestData le reply =
  withObjCPtr requestData $ \raw_requestData ->
    withObjCPtr le $ \raw_le ->
        sendMsg tkSmartCard (mkSelector "sendIns:p1:p2:data:le:reply:") retVoid [argCUChar ins, argCUChar p1, argCUChar p2, argPtr (castPtr raw_requestData :: Ptr ()), argPtr (castPtr raw_le :: Ptr ()), argPtr (castPtr reply :: Ptr ())]
...
setCla tkSmartCard  value =
    sendMsg tkSmartCard (mkSelector "setCla:") retVoid [argCUChar value]
