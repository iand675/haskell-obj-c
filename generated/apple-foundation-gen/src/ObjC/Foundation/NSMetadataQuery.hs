...
resultAtIndex nsMetadataQuery  idx =
    fmap (RawId . castPtr) $ sendMsg nsMetadataQuery (mkSelector "resultAtIndex:") (retPtr retVoid) [argCULong idx]
...
setNotificationBatchingInterval nsMetadataQuery  value =
    sendMsg nsMetadataQuery (mkSelector "setNotificationBatchingInterval:") retVoid [argCDouble value]
