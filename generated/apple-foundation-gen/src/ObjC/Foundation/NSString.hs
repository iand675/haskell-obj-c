...
characterAtIndex nsString  index =
    fmap fromIntegral $ sendMsg nsString (mkSelector "characterAtIndex:") retCUInt [argCULong index]
...
stringByAddingPercentEscapesUsingEncoding nsString  enc =
    sendMsg nsString (mkSelector "stringByAddingPercentEscapesUsingEncoding:") (retPtr retVoid) [argCULong enc] >>= retainedObject . castPtr
...
stringByReplacingPercentEscapesUsingEncoding nsString  enc =
    sendMsg nsString (mkSelector "stringByReplacingPercentEscapesUsingEncoding:") (retPtr retVoid) [argCULong enc] >>= retainedObject . castPtr
...
getFileSystemRepresentation_maxLength nsString  cname max_ =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "getFileSystemRepresentation:maxLength:") retCULong [argPtr cname, argCULong max_]
...
variantFittingPresentationWidth nsString  width =
    sendMsg nsString (mkSelector "variantFittingPresentationWidth:") (retPtr retVoid) [argCLong width] >>= retainedObject . castPtr
...
getCString_maxLength nsString  bytes maxLength =
    sendMsg nsString (mkSelector "getCString:maxLength:") retVoid [argPtr bytes, argCULong maxLength]
...
getCString_maxLength_range_remainingRange nsString  bytes maxLength aRange leftoverRange =
    sendMsg nsString (mkSelector "getCString:maxLength:range:remainingRange:") retVoid [argPtr bytes, argCULong maxLength, argNSRange aRange, argPtr leftoverRange]
...
initWithCStringNoCopy_length_freeWhenDone nsString  bytes length_ freeBuffer =
    fmap (RawId . castPtr) $ sendMsg nsString (mkSelector "initWithCStringNoCopy:length:freeWhenDone:") (retPtr retVoid) [argPtr bytes, argCULong length_, argCULong (if freeBuffer then 1 else 0)]
...
initWithCString_length nsString  bytes length_ =
    fmap (RawId . castPtr) $ sendMsg nsString (mkSelector "initWithCString:length:") (retPtr retVoid) [argPtr (unConst bytes), argCULong length_]
...
stringWithCString_length bytes length_ =
  do
    cls' <- getRequiredClass "NSString"
    fmap (RawId . castPtr) $ sendClassMsg cls' (mkSelector "stringWithCString:length:") (retPtr retVoid) [argPtr (unConst bytes), argCULong length_]
...
substringFromIndex nsString  from =
    sendMsg nsString (mkSelector "substringFromIndex:") (retPtr retVoid) [argCULong from] >>= retainedObject . castPtr

-- | @- substringToIndex:@
substringToIndex :: IsNSString nsString => nsString -> CULong -> IO (Id NSString)
substringToIndex nsString  to =
    sendMsg nsString (mkSelector "substringToIndex:") (retPtr retVoid) [argCULong to] >>= retainedObject . castPtr
...
rangeOfComposedCharacterSequenceAtIndex nsString  index =
    sendMsgStret nsString (mkSelector "rangeOfComposedCharacterSequenceAtIndex:") retNSRange [argCULong index]
...
dataUsingEncoding_allowLossyConversion nsString  encoding lossy =
    sendMsg nsString (mkSelector "dataUsingEncoding:allowLossyConversion:") (retPtr retVoid) [argCULong encoding, argCULong (if lossy then 1 else 0)] >>= retainedObject . castPtr

-- | @- dataUsingEncoding:@
dataUsingEncoding :: IsNSString nsString => nsString -> CULong -> IO (Id NSData)
dataUsingEncoding nsString  encoding =
    sendMsg nsString (mkSelector "dataUsingEncoding:") (retPtr retVoid) [argCULong encoding] >>= retainedObject . castPtr

-- | @- canBeConvertedToEncoding:@
canBeConvertedToEncoding :: IsNSString nsString => nsString -> CULong -> IO Bool
canBeConvertedToEncoding nsString  encoding =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "canBeConvertedToEncoding:") retCULong [argCULong encoding]

-- | @- cStringUsingEncoding:@
cStringUsingEncoding :: IsNSString nsString => nsString -> CULong -> IO (Const (Ptr CChar))
cStringUsingEncoding nsString  encoding =
    fmap Const $ fmap castPtr $ sendMsg nsString (mkSelector "cStringUsingEncoding:") (retPtr retVoid) [argCULong encoding]
...
getCString_maxLength_encoding nsString  buffer maxBufferCount encoding =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "getCString:maxLength:encoding:") retCULong [argPtr buffer, argCULong maxBufferCount, argCULong encoding]
...
getBytes_maxLength_usedLength_encoding_options_range_remainingRange nsString  buffer maxBufferCount usedBufferCount encoding options range leftover =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "getBytes:maxLength:usedLength:encoding:options:range:remainingRange:") retCULong [argPtr buffer, argCULong maxBufferCount, argPtr usedBufferCount, argCULong encoding, argCULong (coerce options), argNSRange range, argPtr leftover]
...
maximumLengthOfBytesUsingEncoding nsString  enc =
    sendMsg nsString (mkSelector "maximumLengthOfBytesUsingEncoding:") retCULong [argCULong enc]

-- | @- lengthOfBytesUsingEncoding:@
lengthOfBytesUsingEncoding :: IsNSString nsString => nsString -> CULong -> IO CULong
lengthOfBytesUsingEncoding nsString  enc =
    sendMsg nsString (mkSelector "lengthOfBytesUsingEncoding:") retCULong [argCULong enc]
...
localizedNameOfStringEncoding encoding =
  do
    cls' <- getRequiredClass "NSString"
    sendClassMsg cls' (mkSelector "localizedNameOfStringEncoding:") (retPtr retVoid) [argCULong encoding] >>= retainedObject . castPtr
...
stringByPaddingToLength_withString_startingAtIndex nsString  newLength padString padIndex =
  withObjCPtr padString $ \raw_padString ->
      sendMsg nsString (mkSelector "stringByPaddingToLength:withString:startingAtIndex:") (retPtr retVoid) [argCULong newLength, argPtr (castPtr raw_padString :: Ptr ()), argCULong padIndex] >>= retainedObject . castPtr
...
writeToURL_atomically_encoding_error nsString  url useAuxiliaryFile enc error_ =
  withObjCPtr url $ \raw_url ->
    withObjCPtr error_ $ \raw_error_ ->
        fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "writeToURL:atomically:encoding:error:") retCULong [argPtr (castPtr raw_url :: Ptr ()), argCULong (if useAuxiliaryFile then 1 else 0), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())]
...
writeToFile_atomically_encoding_error nsString  path useAuxiliaryFile enc error_ =
  withObjCPtr path $ \raw_path ->
    withObjCPtr error_ $ \raw_error_ ->
        fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsString (mkSelector "writeToFile:atomically:encoding:error:") retCULong [argPtr (castPtr raw_path :: Ptr ()), argCULong (if useAuxiliaryFile then 1 else 0), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())]
...
initWithCharactersNoCopy_length_freeWhenDone nsString  characters length_ freeBuffer =
    sendMsg nsString (mkSelector "initWithCharactersNoCopy:length:freeWhenDone:") (retPtr retVoid) [argPtr characters, argCULong length_, argCULong (if freeBuffer then 1 else 0)] >>= ownedObject . castPtr
...
initWithCharactersNoCopy_length_deallocator nsString  chars len deallocator =
    sendMsg nsString (mkSelector "initWithCharactersNoCopy:length:deallocator:") (retPtr retVoid) [argPtr chars, argCULong len, argPtr (castPtr deallocator :: Ptr ())] >>= ownedObject . castPtr
...
initWithCharacters_length nsString  characters length_ =
    sendMsg nsString (mkSelector "initWithCharacters:length:") (retPtr retVoid) [argPtr (unConst characters), argCULong length_] >>= ownedObject . castPtr
...
initWithData_encoding nsString  data_ encoding =
  withObjCPtr data_ $ \raw_data_ ->
      sendMsg nsString (mkSelector "initWithData:encoding:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ()), argCULong encoding] >>= ownedObject . castPtr
...
initWithBytes_length_encoding nsString  bytes len encoding =
    sendMsg nsString (mkSelector "initWithBytes:length:encoding:") (retPtr retVoid) [argPtr (unConst bytes), argCULong len, argCULong encoding] >>= ownedObject . castPtr
...
initWithBytesNoCopy_length_encoding_freeWhenDone nsString  bytes len encoding freeBuffer =
    sendMsg nsString (mkSelector "initWithBytesNoCopy:length:encoding:freeWhenDone:") (retPtr retVoid) [argPtr bytes, argCULong len, argCULong encoding, argCULong (if freeBuffer then 1 else 0)] >>= ownedObject . castPtr
...
initWithBytesNoCopy_length_encoding_deallocator nsString  bytes len encoding deallocator =
    sendMsg nsString (mkSelector "initWithBytesNoCopy:length:encoding:deallocator:") (retPtr retVoid) [argPtr bytes, argCULong len, argCULong encoding, argPtr (castPtr deallocator :: Ptr ())] >>= ownedObject . castPtr
...
stringWithCharacters_length characters length_ =
  do
    cls' <- getRequiredClass "NSString"
    sendClassMsg cls' (mkSelector "stringWithCharacters:length:") (retPtr retVoid) [argPtr (unConst characters), argCULong length_] >>= retainedObject . castPtr
...
initWithCString_encoding nsString  nullTerminatedCString encoding =
    sendMsg nsString (mkSelector "initWithCString:encoding:") (retPtr retVoid) [argPtr (unConst nullTerminatedCString), argCULong encoding] >>= ownedObject . castPtr
...
stringWithCString_encoding cString enc =
  do
    cls' <- getRequiredClass "NSString"
    sendClassMsg cls' (mkSelector "stringWithCString:encoding:") (retPtr retVoid) [argPtr (unConst cString), argCULong enc] >>= retainedObject . castPtr
...
initWithContentsOfURL_encoding_error nsString  url enc error_ =
  withObjCPtr url $ \raw_url ->
    withObjCPtr error_ $ \raw_error_ ->
        sendMsg nsString (mkSelector "initWithContentsOfURL:encoding:error:") (retPtr retVoid) [argPtr (castPtr raw_url :: Ptr ()), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())] >>= ownedObject . castPtr
...
initWithContentsOfFile_encoding_error nsString  path enc error_ =
  withObjCPtr path $ \raw_path ->
    withObjCPtr error_ $ \raw_error_ ->
        sendMsg nsString (mkSelector "initWithContentsOfFile:encoding:error:") (retPtr retVoid) [argPtr (castPtr raw_path :: Ptr ()), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())] >>= ownedObject . castPtr
...
stringWithContentsOfURL_encoding_error url enc error_ =
  do
    ...
    withObjCPtr url $ \raw_url ->
      withObjCPtr error_ $ \raw_error_ ->
        sendClassMsg cls' (mkSelector "stringWithContentsOfURL:encoding:error:") (retPtr retVoid) [argPtr (castPtr raw_url :: Ptr ()), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())] >>= retainedObject . castPtr
...
stringWithContentsOfFile_encoding_error path enc error_ =
  do
    ...
    withObjCPtr path $ \raw_path ->
      withObjCPtr error_ $ \raw_error_ ->
        sendClassMsg cls' (mkSelector "stringWithContentsOfFile:encoding:error:") (retPtr retVoid) [argPtr (castPtr raw_path :: Ptr ()), argCULong enc, argPtr (castPtr raw_error_ :: Ptr ())] >>= retainedObject . castPtr
