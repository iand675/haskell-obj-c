...
--
-- Generated bindings for @MTRBaseClusterCarbonMonoxideConcentrationMeasurement@.
module ObjC.Matter.MTRBaseClusterCarbonMonoxideConcentrationMeasurement
  ( MTRBaseClusterCarbonMonoxideConcentrationMeasurement
  , IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement(..)
...
-- | @- readAttributeMeasuredValueWithCompletion:@
readAttributeMeasuredValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasuredValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
readAttributeMeasuredValueWithClusterStateCache_endpoint_queue_completion clusterStateCacheContainer endpoint queue completion =
  do
    cls' <- getRequiredClass "MTRBaseClusterCarbonMonoxideConcentrationMeasurement"
...
-- | @- readAttributeMinMeasuredValueWithCompletion:@
readAttributeMinMeasuredValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMinMeasuredValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeMinMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMinMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMaxMeasuredValueWithCompletion:@
readAttributeMaxMeasuredValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMaxMeasuredValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeMaxMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMaxMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributePeakMeasuredValueWithCompletion:@
readAttributePeakMeasuredValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributePeakMeasuredValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributePeakMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributePeakMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributePeakMeasuredValueWindowWithCompletion:@
readAttributePeakMeasuredValueWindowWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributePeakMeasuredValueWindowWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributePeakMeasuredValueWindowWithCompletionSelector completion

-- | @- subscribeAttributePeakMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAverageMeasuredValueWithCompletion:@
readAttributeAverageMeasuredValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAverageMeasuredValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeAverageMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeAverageMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAverageMeasuredValueWindowWithCompletion:@
readAttributeAverageMeasuredValueWindowWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAverageMeasuredValueWindowWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeAverageMeasuredValueWindowWithCompletionSelector completion

-- | @- subscribeAttributeAverageMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeUncertaintyWithCompletion:@
readAttributeUncertaintyWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeUncertaintyWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeUncertaintyWithCompletionSelector completion

-- | @- subscribeAttributeUncertaintyWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMeasurementUnitWithCompletion:@
readAttributeMeasurementUnitWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasurementUnitWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeMeasurementUnitWithCompletionSelector completion

-- | @- subscribeAttributeMeasurementUnitWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMeasurementMediumWithCompletion:@
readAttributeMeasurementMediumWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasurementMediumWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeMeasurementMediumWithCompletionSelector completion

-- | @- subscribeAttributeMeasurementMediumWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeLevelValueWithCompletion:@
readAttributeLevelValueWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeLevelValueWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeLevelValueWithCompletionSelector completion

-- | @- subscribeAttributeLevelValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeGeneratedCommandListWithCompletion:@
readAttributeGeneratedCommandListWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeGeneratedCommandListWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeGeneratedCommandListWithCompletionSelector completion

-- | @- subscribeAttributeGeneratedCommandListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAcceptedCommandListWithCompletion:@
readAttributeAcceptedCommandListWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAcceptedCommandListWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeAcceptedCommandListWithCompletionSelector completion

-- | @- subscribeAttributeAcceptedCommandListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAttributeListWithCompletion:@
readAttributeAttributeListWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAttributeListWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeAttributeListWithCompletionSelector completion

-- | @- subscribeAttributeAttributeListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeFeatureMapWithCompletion:@
readAttributeFeatureMapWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeFeatureMapWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeFeatureMapWithCompletionSelector completion

-- | @- subscribeAttributeFeatureMapWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeClusterRevisionWithCompletion:@
readAttributeClusterRevisionWithCompletion :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> Ptr () -> IO ()
readAttributeClusterRevisionWithCompletion mtrBaseClusterCarbonMonoxideConcentrationMeasurement completion =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement readAttributeClusterRevisionWithCompletionSelector completion

-- | @- subscribeAttributeClusterRevisionWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandler mtrBaseClusterCarbonMonoxideConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- init@
init_ :: IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> IO (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
init_ mtrBaseClusterCarbonMonoxideConcentrationMeasurement =
  sendOwnedMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement initSelector

-- | @+ new@
new :: IO (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
new  =
  do
    cls' <- getRequiredClass "MTRBaseClusterCarbonMonoxideConcentrationMeasurement"
...
initWithDevice_endpointID_queue :: (IsMTRBaseClusterCarbonMonoxideConcentrationMeasurement mtrBaseClusterCarbonMonoxideConcentrationMeasurement, IsMTRBaseDevice device, IsNSNumber endpointID, IsNSObject queue) => mtrBaseClusterCarbonMonoxideConcentrationMeasurement -> device -> endpointID -> queue -> IO (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
initWithDevice_endpointID_queue mtrBaseClusterCarbonMonoxideConcentrationMeasurement device endpointID queue =
  sendOwnedMessage mtrBaseClusterCarbonMonoxideConcentrationMeasurement initWithDevice_endpointID_queueSelector (toMTRBaseDevice device) (toNSNumber endpointID) (toNSObject queue)
...
-- | @Selector@ for @init@
initSelector :: Selector '[] (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
initSelector = mkSelector "init"

-- | @Selector@ for @new@
newSelector :: Selector '[] (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
newSelector = mkSelector "new"

-- | @Selector@ for @initWithDevice:endpointID:queue:@
initWithDevice_endpointID_queueSelector :: Selector '[Id MTRBaseDevice, Id NSNumber, Id NSObject] (Id MTRBaseClusterCarbonMonoxideConcentrationMeasurement)
