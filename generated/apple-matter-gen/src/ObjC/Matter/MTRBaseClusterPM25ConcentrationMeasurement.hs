...
--
-- Generated bindings for @MTRBaseClusterPM25ConcentrationMeasurement@.
module ObjC.Matter.MTRBaseClusterPM25ConcentrationMeasurement
  ( MTRBaseClusterPM25ConcentrationMeasurement
  , IsMTRBaseClusterPM25ConcentrationMeasurement(..)
...
-- | @- readAttributeMeasuredValueWithCompletion:@
readAttributeMeasuredValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasuredValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
readAttributeMeasuredValueWithClusterStateCache_endpoint_queue_completion clusterStateCacheContainer endpoint queue completion =
  do
    cls' <- getRequiredClass "MTRBaseClusterPM25ConcentrationMeasurement"
...
-- | @- readAttributeMinMeasuredValueWithCompletion:@
readAttributeMinMeasuredValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMinMeasuredValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeMinMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMinMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeMinMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMaxMeasuredValueWithCompletion:@
readAttributeMaxMeasuredValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMaxMeasuredValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeMaxMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeMaxMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeMaxMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributePeakMeasuredValueWithCompletion:@
readAttributePeakMeasuredValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributePeakMeasuredValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributePeakMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributePeakMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributePeakMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributePeakMeasuredValueWindowWithCompletion:@
readAttributePeakMeasuredValueWindowWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributePeakMeasuredValueWindowWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributePeakMeasuredValueWindowWithCompletionSelector completion

-- | @- subscribeAttributePeakMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributePeakMeasuredValueWindowWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAverageMeasuredValueWithCompletion:@
readAttributeAverageMeasuredValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAverageMeasuredValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeAverageMeasuredValueWithCompletionSelector completion

-- | @- subscribeAttributeAverageMeasuredValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeAverageMeasuredValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAverageMeasuredValueWindowWithCompletion:@
readAttributeAverageMeasuredValueWindowWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAverageMeasuredValueWindowWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeAverageMeasuredValueWindowWithCompletionSelector completion

-- | @- subscribeAttributeAverageMeasuredValueWindowWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeAverageMeasuredValueWindowWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeUncertaintyWithCompletion:@
readAttributeUncertaintyWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeUncertaintyWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeUncertaintyWithCompletionSelector completion

-- | @- subscribeAttributeUncertaintyWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeUncertaintyWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMeasurementUnitWithCompletion:@
readAttributeMeasurementUnitWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasurementUnitWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeMeasurementUnitWithCompletionSelector completion

-- | @- subscribeAttributeMeasurementUnitWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeMeasurementUnitWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeMeasurementMediumWithCompletion:@
readAttributeMeasurementMediumWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeMeasurementMediumWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeMeasurementMediumWithCompletionSelector completion

-- | @- subscribeAttributeMeasurementMediumWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeMeasurementMediumWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeLevelValueWithCompletion:@
readAttributeLevelValueWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeLevelValueWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeLevelValueWithCompletionSelector completion

-- | @- subscribeAttributeLevelValueWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeLevelValueWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeGeneratedCommandListWithCompletion:@
readAttributeGeneratedCommandListWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeGeneratedCommandListWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeGeneratedCommandListWithCompletionSelector completion

-- | @- subscribeAttributeGeneratedCommandListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeGeneratedCommandListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAcceptedCommandListWithCompletion:@
readAttributeAcceptedCommandListWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAcceptedCommandListWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeAcceptedCommandListWithCompletionSelector completion

-- | @- subscribeAttributeAcceptedCommandListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeAcceptedCommandListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeAttributeListWithCompletion:@
readAttributeAttributeListWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeAttributeListWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeAttributeListWithCompletionSelector completion

-- | @- subscribeAttributeAttributeListWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeAttributeListWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeFeatureMapWithCompletion:@
readAttributeFeatureMapWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeFeatureMapWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeFeatureMapWithCompletionSelector completion

-- | @- subscribeAttributeFeatureMapWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeFeatureMapWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- readAttributeClusterRevisionWithCompletion:@
readAttributeClusterRevisionWithCompletion :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> Ptr () -> IO ()
readAttributeClusterRevisionWithCompletion mtrBaseClusterPM25ConcentrationMeasurement completion =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement readAttributeClusterRevisionWithCompletionSelector completion

-- | @- subscribeAttributeClusterRevisionWithParams:subscriptionEstablished:reportHandler:@
subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandler :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRSubscribeParams params) => mtrBaseClusterPM25ConcentrationMeasurement -> params -> Ptr () -> Ptr () -> IO ()
subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandler mtrBaseClusterPM25ConcentrationMeasurement params subscriptionEstablished reportHandler =
  sendMessage mtrBaseClusterPM25ConcentrationMeasurement subscribeAttributeClusterRevisionWithParams_subscriptionEstablished_reportHandlerSelector (toMTRSubscribeParams params) subscriptionEstablished reportHandler
...
-- | @- init@
init_ :: IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement => mtrBaseClusterPM25ConcentrationMeasurement -> IO (Id MTRBaseClusterPM25ConcentrationMeasurement)
init_ mtrBaseClusterPM25ConcentrationMeasurement =
  sendOwnedMessage mtrBaseClusterPM25ConcentrationMeasurement initSelector

-- | @+ new@
new :: IO (Id MTRBaseClusterPM25ConcentrationMeasurement)
new  =
  do
    cls' <- getRequiredClass "MTRBaseClusterPM25ConcentrationMeasurement"
...
initWithDevice_endpointID_queue :: (IsMTRBaseClusterPM25ConcentrationMeasurement mtrBaseClusterPM25ConcentrationMeasurement, IsMTRBaseDevice device, IsNSNumber endpointID, IsNSObject queue) => mtrBaseClusterPM25ConcentrationMeasurement -> device -> endpointID -> queue -> IO (Id MTRBaseClusterPM25ConcentrationMeasurement)
initWithDevice_endpointID_queue mtrBaseClusterPM25ConcentrationMeasurement device endpointID queue =
  sendOwnedMessage mtrBaseClusterPM25ConcentrationMeasurement initWithDevice_endpointID_queueSelector (toMTRBaseDevice device) (toNSNumber endpointID) (toNSObject queue)
...
-- | @Selector@ for @init@
initSelector :: Selector '[] (Id MTRBaseClusterPM25ConcentrationMeasurement)
initSelector = mkSelector "init"

-- | @Selector@ for @new@
newSelector :: Selector '[] (Id MTRBaseClusterPM25ConcentrationMeasurement)
newSelector = mkSelector "new"

-- | @Selector@ for @initWithDevice:endpointID:queue:@
initWithDevice_endpointID_queueSelector :: Selector '[Id MTRBaseDevice, Id NSNumber, Id NSObject] (Id MTRBaseClusterPM25ConcentrationMeasurement)
