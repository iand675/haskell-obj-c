...
-- | Generated bindings for @MTRBooleanStateConfigurationClusterEnableDisableAlarmParams@.
module ObjC.Matter.MTRBooleanStateConfigurationClusterEnableDisableAlarmParams
