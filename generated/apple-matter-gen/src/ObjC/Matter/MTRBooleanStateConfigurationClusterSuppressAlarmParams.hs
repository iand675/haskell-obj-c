...
-- | Generated bindings for @MTRBooleanStateConfigurationClusterSuppressAlarmParams@.
module ObjC.Matter.MTRBooleanStateConfigurationClusterSuppressAlarmParams
  ( MTRBooleanStateConfigurationClusterSuppressAlarmParams
  , IsMTRBooleanStateConfigurationClusterSuppressAlarmParams(..)
  , alarmsToSuppress
  , setAlarmsToSuppress
