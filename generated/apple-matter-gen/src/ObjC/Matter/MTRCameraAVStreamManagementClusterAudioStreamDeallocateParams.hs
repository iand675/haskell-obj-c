...
audioStreamID mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams audioStreamIDSelector
...
setAudioStreamID mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams value =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams setAudioStreamIDSelector (toNSNumber value)
...
timedInvokeTimeoutMs mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams value =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
...
serverSideProcessingTimeout mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams serverSideProcessingTimeoutSelector
...
setServerSideProcessingTimeout mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams value =
  sendMessage mtrCameraAVStreamManagementClusterAudioStreamDeallocateParams setServerSideProcessingTimeoutSelector (toNSNumber value)
