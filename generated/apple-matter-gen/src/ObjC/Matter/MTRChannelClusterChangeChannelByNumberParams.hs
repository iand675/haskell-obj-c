...
majorNumber mtrChannelClusterChangeChannelByNumberParams =
  sendMessage mtrChannelClusterChangeChannelByNumberParams majorNumberSelector
...
setMajorNumber mtrChannelClusterChangeChannelByNumberParams value =
  sendMessage mtrChannelClusterChangeChannelByNumberParams setMajorNumberSelector (toNSNumber value)
...
minorNumber mtrChannelClusterChangeChannelByNumberParams =
  sendMessage mtrChannelClusterChangeChannelByNumberParams minorNumberSelector
...
setMinorNumber mtrChannelClusterChangeChannelByNumberParams value =
  sendMessage mtrChannelClusterChangeChannelByNumberParams setMinorNumberSelector (toNSNumber value)
...
timedInvokeTimeoutMs mtrChannelClusterChangeChannelByNumberParams =
  sendMessage mtrChannelClusterChangeChannelByNumberParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrChannelClusterChangeChannelByNumberParams value =
  sendMessage mtrChannelClusterChangeChannelByNumberParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
...
serverSideProcessingTimeout mtrChannelClusterChangeChannelByNumberParams =
  sendMessage mtrChannelClusterChangeChannelByNumberParams serverSideProcessingTimeoutSelector
...
setServerSideProcessingTimeout mtrChannelClusterChangeChannelByNumberParams value =
  sendMessage mtrChannelClusterChangeChannelByNumberParams setServerSideProcessingTimeoutSelector (toNSNumber value)
