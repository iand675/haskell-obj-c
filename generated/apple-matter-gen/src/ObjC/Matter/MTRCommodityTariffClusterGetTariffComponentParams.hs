...
-- | Generated bindings for @MTRCommodityTariffClusterGetTariffComponentParams@.
module ObjC.Matter.MTRCommodityTariffClusterGetTariffComponentParams
  ( MTRCommodityTariffClusterGetTariffComponentParams
  , IsMTRCommodityTariffClusterGetTariffComponentParams(..)
  , tariffComponentID
