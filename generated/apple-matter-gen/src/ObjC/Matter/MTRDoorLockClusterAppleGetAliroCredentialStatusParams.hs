...
-- | Generated bindings for @MTRDoorLockClusterAppleGetAliroCredentialStatusParams@.
module ObjC.Matter.MTRDoorLockClusterAppleGetAliroCredentialStatusParams
  ( MTRDoorLockClusterAppleGetAliroCredentialStatusParams
  , IsMTRDoorLockClusterAppleGetAliroCredentialStatusParams(..)
  , credential
  , setCredential
