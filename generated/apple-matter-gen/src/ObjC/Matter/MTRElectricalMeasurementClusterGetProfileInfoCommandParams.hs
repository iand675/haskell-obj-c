...
-- | Generated bindings for @MTRElectricalMeasurementClusterGetProfileInfoCommandParams@.
module ObjC.Matter.MTRElectricalMeasurementClusterGetProfileInfoCommandParams
  ( MTRElectricalMeasurementClusterGetProfileInfoCommandParams
  , IsMTRElectricalMeasurementClusterGetProfileInfoCommandParams(..)
