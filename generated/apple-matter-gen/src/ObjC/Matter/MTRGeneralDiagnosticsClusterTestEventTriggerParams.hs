...
enableKey mtrGeneralDiagnosticsClusterTestEventTriggerParams =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams enableKeySelector
...
setEnableKey mtrGeneralDiagnosticsClusterTestEventTriggerParams value =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams setEnableKeySelector (toNSData value)
...
eventTrigger mtrGeneralDiagnosticsClusterTestEventTriggerParams =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams eventTriggerSelector
...
setEventTrigger mtrGeneralDiagnosticsClusterTestEventTriggerParams value =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams setEventTriggerSelector (toNSNumber value)
...
timedInvokeTimeoutMs mtrGeneralDiagnosticsClusterTestEventTriggerParams =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrGeneralDiagnosticsClusterTestEventTriggerParams value =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
...
serverSideProcessingTimeout mtrGeneralDiagnosticsClusterTestEventTriggerParams =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams serverSideProcessingTimeoutSelector
...
setServerSideProcessingTimeout mtrGeneralDiagnosticsClusterTestEventTriggerParams value =
  sendMessage mtrGeneralDiagnosticsClusterTestEventTriggerParams setServerSideProcessingTimeoutSelector (toNSNumber value)
...
eventTriggerSelector :: Selector '[] (Id NSNumber)
eventTriggerSelector = mkSelector "eventTrigger"

-- | @Selector@ for @setEventTrigger:@
setEventTriggerSelector :: Selector '[Id NSNumber] ()
