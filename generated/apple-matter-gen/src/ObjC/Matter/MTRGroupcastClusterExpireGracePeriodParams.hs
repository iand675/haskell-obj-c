...
-- | Generated bindings for @MTRGroupcastClusterExpireGracePeriodParams@.
module ObjC.Matter.MTRGroupcastClusterExpireGracePeriodParams
  ( MTRGroupcastClusterExpireGracePeriodParams
  , IsMTRGroupcastClusterExpireGracePeriodParams(..)
  , groupID
  , setGroupID
