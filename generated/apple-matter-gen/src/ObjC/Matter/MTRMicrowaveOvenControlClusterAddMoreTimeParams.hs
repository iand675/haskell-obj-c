...
-- | Generated bindings for @MTRMicrowaveOvenControlClusterAddMoreTimeParams@.
module ObjC.Matter.MTRMicrowaveOvenControlClusterAddMoreTimeParams
  ( MTRMicrowaveOvenControlClusterAddMoreTimeParams
  , IsMTRMicrowaveOvenControlClusterAddMoreTimeParams(..)
  , timeToAdd
  , setTimeToAdd
