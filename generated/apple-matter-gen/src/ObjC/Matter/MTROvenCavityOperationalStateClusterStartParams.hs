...
-- | Generated bindings for @MTROvenCavityOperationalStateClusterStartParams@.
module ObjC.Matter.MTROvenCavityOperationalStateClusterStartParams
  ( MTROvenCavityOperationalStateClusterStartParams
  , IsMTROvenCavityOperationalStateClusterStartParams(..)
