...
-- | Generated bindings for @MTRScenesManagementClusterStoreSceneParams@.
module ObjC.Matter.MTRScenesManagementClusterStoreSceneParams
  ( MTRScenesManagementClusterStoreSceneParams
  , IsMTRScenesManagementClusterStoreSceneParams(..)
  , groupID
  , setGroupID
  , sceneID
  , setSceneID
