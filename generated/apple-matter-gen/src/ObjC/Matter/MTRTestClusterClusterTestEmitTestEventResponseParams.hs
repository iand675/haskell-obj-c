...
value mtrTestClusterClusterTestEmitTestEventResponseParams =
  sendMessage mtrTestClusterClusterTestEmitTestEventResponseParams valueSelector
...
setValue mtrTestClusterClusterTestEmitTestEventResponseParams value =
  sendMessage mtrTestClusterClusterTestEmitTestEventResponseParams setValueSelector (toNSNumber value)
...
timedInvokeTimeoutMs mtrTestClusterClusterTestEmitTestEventResponseParams =
  sendMessage mtrTestClusterClusterTestEmitTestEventResponseParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrTestClusterClusterTestEmitTestEventResponseParams value =
  sendMessage mtrTestClusterClusterTestEmitTestEventResponseParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
