...
-- | Generated bindings for @MTRThermostatClusterSetActivePresetRequestParams@.
module ObjC.Matter.MTRThermostatClusterSetActivePresetRequestParams
  ( MTRThermostatClusterSetActivePresetRequestParams
  , IsMTRThermostatClusterSetActivePresetRequestParams(..)
  , presetHandle
  , setPresetHandle
