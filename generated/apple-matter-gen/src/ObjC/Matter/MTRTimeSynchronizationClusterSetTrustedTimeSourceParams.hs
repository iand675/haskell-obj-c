...
-- | Generated bindings for @MTRTimeSynchronizationClusterSetTrustedTimeSourceParams@.
module ObjC.Matter.MTRTimeSynchronizationClusterSetTrustedTimeSourceParams
  ( MTRTimeSynchronizationClusterSetTrustedTimeSourceParams
  , IsMTRTimeSynchronizationClusterSetTrustedTimeSourceParams(..)
  , trustedTimeSource
