...
additionalTime mtrTimerClusterAddTimeParams =
  sendMessage mtrTimerClusterAddTimeParams additionalTimeSelector
...
setAdditionalTime mtrTimerClusterAddTimeParams value =
  sendMessage mtrTimerClusterAddTimeParams setAdditionalTimeSelector (toNSNumber value)
...
timedInvokeTimeoutMs mtrTimerClusterAddTimeParams =
  sendMessage mtrTimerClusterAddTimeParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrTimerClusterAddTimeParams value =
  sendMessage mtrTimerClusterAddTimeParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
...
serverSideProcessingTimeout mtrTimerClusterAddTimeParams =
  sendMessage mtrTimerClusterAddTimeParams serverSideProcessingTimeoutSelector
...
setServerSideProcessingTimeout mtrTimerClusterAddTimeParams value =
  sendMessage mtrTimerClusterAddTimeParams setServerSideProcessingTimeoutSelector (toNSNumber value)
...
additionalTimeSelector :: Selector '[] (Id NSNumber)
additionalTimeSelector = mkSelector "additionalTime"

-- | @Selector@ for @setAdditionalTime:@
setAdditionalTimeSelector :: Selector '[Id NSNumber] ()
