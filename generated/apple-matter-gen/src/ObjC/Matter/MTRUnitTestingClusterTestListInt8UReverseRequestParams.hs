...
arg1 mtrUnitTestingClusterTestListInt8UReverseRequestParams =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams arg1Selector
...
setArg1 mtrUnitTestingClusterTestListInt8UReverseRequestParams value =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams setArg1Selector (toNSArray value)
...
timedInvokeTimeoutMs mtrUnitTestingClusterTestListInt8UReverseRequestParams =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams timedInvokeTimeoutMsSelector
...
setTimedInvokeTimeoutMs mtrUnitTestingClusterTestListInt8UReverseRequestParams value =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams setTimedInvokeTimeoutMsSelector (toNSNumber value)
...
serverSideProcessingTimeout mtrUnitTestingClusterTestListInt8UReverseRequestParams =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams serverSideProcessingTimeoutSelector
...
setServerSideProcessingTimeout mtrUnitTestingClusterTestListInt8UReverseRequestParams value =
  sendMessage mtrUnitTestingClusterTestListInt8UReverseRequestParams setServerSideProcessingTimeoutSelector (toNSNumber value)
