...
-- | Generated bindings for @MTRZoneManagementClusterCreateTwoDCartesianZoneParams@.
module ObjC.Matter.MTRZoneManagementClusterCreateTwoDCartesianZoneParams
  ( MTRZoneManagementClusterCreateTwoDCartesianZoneParams
  , IsMTRZoneManagementClusterCreateTwoDCartesianZoneParams(..)
  , zone
  , setZone
