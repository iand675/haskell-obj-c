...
lookupArchives mtL4CompilerTaskOptions =
  sendMessage mtL4CompilerTaskOptions lookupArchivesSelector
...
setLookupArchives mtL4CompilerTaskOptions value =
  sendMessage mtL4CompilerTaskOptions setLookupArchivesSelector (toNSArray value)
...
lookupArchivesSelector :: Selector '[] (Id NSArray)
lookupArchivesSelector = mkSelector "lookupArchives"

-- | @Selector@ for @setLookupArchives:@
setLookupArchivesSelector :: Selector '[Id NSArray] ()
