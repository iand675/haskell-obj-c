...
setControlPointCount mtlAccelerationStructureMotionCurveGeometryDescriptor  value =
    sendMsg mtlAccelerationStructureMotionCurveGeometryDescriptor (mkSelector "setControlPointCount:") retVoid [argCULong value]
...
setControlPointStride mtlAccelerationStructureMotionCurveGeometryDescriptor  value =
    sendMsg mtlAccelerationStructureMotionCurveGeometryDescriptor (mkSelector "setControlPointStride:") retVoid [argCULong value]
...
setIndexBufferOffset mtlAccelerationStructureMotionCurveGeometryDescriptor  value =
    sendMsg mtlAccelerationStructureMotionCurveGeometryDescriptor (mkSelector "setIndexBufferOffset:") retVoid [argCULong value]
...
setSegmentCount mtlAccelerationStructureMotionCurveGeometryDescriptor  value =
    sendMsg mtlAccelerationStructureMotionCurveGeometryDescriptor (mkSelector "setSegmentCount:") retVoid [argCULong value]
...
setSegmentControlPointCount mtlAccelerationStructureMotionCurveGeometryDescriptor  value =
    sendMsg mtlAccelerationStructureMotionCurveGeometryDescriptor (mkSelector "setSegmentControlPointCount:") retVoid [argCULong value]
