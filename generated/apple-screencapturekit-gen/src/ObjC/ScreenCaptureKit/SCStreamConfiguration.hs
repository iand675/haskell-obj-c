...
setWidth scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setWidth:") retVoid [argCULong value]
...
setHeight scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setHeight:") retVoid [argCULong value]
...
setPixelFormat scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setPixelFormat:") retVoid [argCUInt value]
...
setQueueDepth scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setQueueDepth:") retVoid [argCLong value]
...
setSampleRate scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setSampleRate:") retVoid [argCLong value]
...
setChannelCount scStreamConfiguration  value =
    sendMsg scStreamConfiguration (mkSelector "setChannelCount:") retVoid [argCLong value]
