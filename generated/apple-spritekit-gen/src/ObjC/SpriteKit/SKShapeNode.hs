...
setLineWidth skShapeNode  value =
    sendMsg skShapeNode (mkSelector "setLineWidth:") retVoid [argCDouble value]
...
setGlowWidth skShapeNode  value =
    sendMsg skShapeNode (mkSelector "setGlowWidth:") retVoid [argCDouble value]
...
lineCap skShapeNode  =
    sendMsg skShapeNode (mkSelector "lineCap") retCInt []
...
setLineCap skShapeNode  value =
    sendMsg skShapeNode (mkSelector "setLineCap:") retVoid [argCInt (fromIntegral value)]
...
lineJoin skShapeNode  =
    sendMsg skShapeNode (mkSelector "lineJoin") retCInt []
...
setLineJoin skShapeNode  value =
    sendMsg skShapeNode (mkSelector "setLineJoin:") retVoid [argCInt (fromIntegral value)]
...
setMiterLimit skShapeNode  value =
    sendMsg skShapeNode (mkSelector "setMiterLimit:") retVoid [argCDouble value]
