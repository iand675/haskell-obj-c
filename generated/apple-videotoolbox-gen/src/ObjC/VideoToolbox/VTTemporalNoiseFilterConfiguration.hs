...
initWithFrameWidth_frameHeight_sourcePixelFormat vtTemporalNoiseFilterConfiguration  frameWidth frameHeight sourcePixelFormat =
    sendMsg vtTemporalNoiseFilterConfiguration (mkSelector "initWithFrameWidth:frameHeight:sourcePixelFormat:") (retPtr retVoid) [argCLong frameWidth, argCLong frameHeight, argCUInt sourcePixelFormat] >>= ownedObject . castPtr
