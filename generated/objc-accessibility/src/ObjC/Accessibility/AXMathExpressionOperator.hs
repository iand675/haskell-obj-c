...
withObjCPtr content $ \raw_content ->
    sendMsg axMathExpressionOperator (mkSelector "initWithContent:") (retPtr retVoid) [argPtr (castPtr raw_content :: Ptr ())] >>= ownedObject . castPtr
...
content axMathExpressionOperator  =
  sendMsg axMathExpressionOperator (mkSelector "content") (retPtr retVoid) [] >>= retainedObject . castPtr
