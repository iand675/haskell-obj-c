...
withObjCPtr title $ \raw_title ->
  withObjCPtr gridlinePositions $ \raw_gridlinePositions ->
      sendMsg axNumericDataAxisDescriptor (mkSelector "initWithTitle:lowerBound:upperBound:gridlinePositions:valueDescriptionProvider:") (retPtr retVoid) [argPtr (castPtr raw_title :: Ptr ()), argCDouble (fromIntegral lowerbound), argCDouble (fromIntegral upperBound), argPtr (castPtr raw_gridlinePositions :: Ptr ()), argPtr (castPtr valueDescriptionProvider :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr attributedTitle $ \raw_attributedTitle ->
  withObjCPtr gridlinePositions $ \raw_gridlinePositions ->
      sendMsg axNumericDataAxisDescriptor (mkSelector "initWithAttributedTitle:lowerBound:upperBound:gridlinePositions:valueDescriptionProvider:") (retPtr retVoid) [argPtr (castPtr raw_attributedTitle :: Ptr ()), argCDouble (fromIntegral lowerbound), argCDouble (fromIntegral upperBound), argPtr (castPtr raw_gridlinePositions :: Ptr ()), argPtr (castPtr valueDescriptionProvider :: Ptr ())] >>= ownedObject . castPtr
...
setLowerBound axNumericDataAxisDescriptor  value =
  sendMsg axNumericDataAxisDescriptor (mkSelector "setLowerBound:") retVoid [argCDouble (fromIntegral value)]
...
setUpperBound axNumericDataAxisDescriptor  value =
  sendMsg axNumericDataAxisDescriptor (mkSelector "setUpperBound:") retVoid [argCDouble (fromIntegral value)]
