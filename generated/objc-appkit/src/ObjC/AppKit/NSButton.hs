...
setPeriodicDelay_interval nsButton  delay interval =
  sendMsg nsButton (mkSelector "setPeriodicDelay:interval:") retVoid [argCFloat (fromIntegral delay), argCFloat (fromIntegral interval)]
...
setMaxAcceleratorLevel nsButton  value =
  sendMsg nsButton (mkSelector "setMaxAcceleratorLevel:") retVoid [argCLong (fromIntegral value)]
...
setState nsButton  value =
  sendMsg nsButton (mkSelector "setState:") retVoid [argCLong (fromIntegral value)]
