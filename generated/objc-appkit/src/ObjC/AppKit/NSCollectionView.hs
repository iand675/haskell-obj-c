...
frameForItemAtIndex nsCollectionView  index =
  sendMsgStret nsCollectionView (mkSelector "frameForItemAtIndex:") retNSRect [argCULong (fromIntegral index)]
...
frameForItemAtIndex_withNumberOfItems nsCollectionView  index numberOfItems =
  sendMsgStret nsCollectionView (mkSelector "frameForItemAtIndex:withNumberOfItems:") retNSRect [argCULong (fromIntegral index), argCULong (fromIntegral numberOfItems)]
...
numberOfItemsInSection nsCollectionView  section =
  sendMsg nsCollectionView (mkSelector "numberOfItemsInSection:") retCLong [argCLong (fromIntegral section)]
...
itemAtIndex nsCollectionView  index =
  sendMsg nsCollectionView (mkSelector "itemAtIndex:") (retPtr retVoid) [argCULong (fromIntegral index)] >>= retainedObject . castPtr
...
moveSection_toSection nsCollectionView  section newSection =
  sendMsg nsCollectionView (mkSelector "moveSection:toSection:") retVoid [argCLong (fromIntegral section), argCLong (fromIntegral newSection)]
...
setMaxNumberOfRows nsCollectionView  value =
  sendMsg nsCollectionView (mkSelector "setMaxNumberOfRows:") retVoid [argCULong (fromIntegral value)]
...
setMaxNumberOfColumns nsCollectionView  value =
  sendMsg nsCollectionView (mkSelector "setMaxNumberOfColumns:") retVoid [argCULong (fromIntegral value)]
