...
scrollItemAtIndexToTop nsComboBoxCell  index =
  sendMsg nsComboBoxCell (mkSelector "scrollItemAtIndexToTop:") retVoid [argCLong (fromIntegral index)]
...
scrollItemAtIndexToVisible nsComboBoxCell  index =
  sendMsg nsComboBoxCell (mkSelector "scrollItemAtIndexToVisible:") retVoid [argCLong (fromIntegral index)]

-- | @- selectItemAtIndex:@
selectItemAtIndex :: IsNSComboBoxCell nsComboBoxCell => nsComboBoxCell -> CLong -> IO ()
selectItemAtIndex nsComboBoxCell  index =
  sendMsg nsComboBoxCell (mkSelector "selectItemAtIndex:") retVoid [argCLong (fromIntegral index)]

-- | @- deselectItemAtIndex:@
deselectItemAtIndex :: IsNSComboBoxCell nsComboBoxCell => nsComboBoxCell -> CLong -> IO ()
deselectItemAtIndex nsComboBoxCell  index =
  sendMsg nsComboBoxCell (mkSelector "deselectItemAtIndex:") retVoid [argCLong (fromIntegral index)]
...
insertItemWithObjectValue_atIndex nsComboBoxCell  object index =
  sendMsg nsComboBoxCell (mkSelector "insertItemWithObjectValue:atIndex:") retVoid [argPtr (castPtr (unRawId object) :: Ptr ()), argCLong (fromIntegral index)]
...
removeItemAtIndex nsComboBoxCell  index =
  sendMsg nsComboBoxCell (mkSelector "removeItemAtIndex:") retVoid [argCLong (fromIntegral index)]
...
itemObjectValueAtIndex nsComboBoxCell  index =
  fmap (RawId . castPtr) $ sendMsg nsComboBoxCell (mkSelector "itemObjectValueAtIndex:") (retPtr retVoid) [argCLong (fromIntegral index)]
...
setItemHeight nsComboBoxCell  value =
  sendMsg nsComboBoxCell (mkSelector "setItemHeight:") retVoid [argCDouble (fromIntegral value)]
...
setNumberOfVisibleItems nsComboBoxCell  value =
  sendMsg nsComboBoxCell (mkSelector "setNumberOfVisibleItems:") retVoid [argCLong (fromIntegral value)]
