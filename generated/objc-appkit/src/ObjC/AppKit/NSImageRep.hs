...
setBitsPerSample nsImageRep  value =
  sendMsg nsImageRep (mkSelector "setBitsPerSample:") retVoid [argCLong (fromIntegral value)]
...
setPixelsWide nsImageRep  value =
  sendMsg nsImageRep (mkSelector "setPixelsWide:") retVoid [argCLong (fromIntegral value)]
...
setPixelsHigh nsImageRep  value =
  sendMsg nsImageRep (mkSelector "setPixelsHigh:") retVoid [argCLong (fromIntegral value)]
