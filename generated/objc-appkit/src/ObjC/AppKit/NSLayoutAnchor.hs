...
withObjCPtr anchor $ \raw_anchor ->
    sendMsg nsLayoutAnchor (mkSelector "constraintEqualToAnchor:constant:") (retPtr retVoid) [argPtr (castPtr raw_anchor :: Ptr ()), argCDouble (fromIntegral c)] >>= retainedObject . castPtr
...
withObjCPtr anchor $ \raw_anchor ->
    sendMsg nsLayoutAnchor (mkSelector "constraintGreaterThanOrEqualToAnchor:constant:") (retPtr retVoid) [argPtr (castPtr raw_anchor :: Ptr ()), argCDouble (fromIntegral c)] >>= retainedObject . castPtr
...
withObjCPtr anchor $ \raw_anchor ->
    sendMsg nsLayoutAnchor (mkSelector "constraintLessThanOrEqualToAnchor:constant:") (retPtr retVoid) [argPtr (castPtr raw_anchor :: Ptr ()), argCDouble (fromIntegral c)] >>= retainedObject . castPtr
