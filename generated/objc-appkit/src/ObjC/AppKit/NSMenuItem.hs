...
setMnemonicLocation nsMenuItem  location =
  sendMsg nsMenuItem (mkSelector "setMnemonicLocation:") retVoid [argCULong (fromIntegral location)]
...
setState nsMenuItem  value =
  sendMsg nsMenuItem (mkSelector "setState:") retVoid [argCLong (fromIntegral value)]
...
setIndentationLevel nsMenuItem  value =
  sendMsg nsMenuItem (mkSelector "setIndentationLevel:") retVoid [argCLong (fromIntegral value)]
...
setTag nsMenuItem  value =
  sendMsg nsMenuItem (mkSelector "setTag:") retVoid [argCLong (fromIntegral value)]
