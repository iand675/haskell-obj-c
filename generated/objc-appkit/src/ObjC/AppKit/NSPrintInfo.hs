...
setScalingFactor nsPrintInfo  value =
  sendMsg nsPrintInfo (mkSelector "setScalingFactor:") retVoid [argCDouble (fromIntegral value)]
...
setLeftMargin nsPrintInfo  value =
  sendMsg nsPrintInfo (mkSelector "setLeftMargin:") retVoid [argCDouble (fromIntegral value)]
...
setRightMargin nsPrintInfo  value =
  sendMsg nsPrintInfo (mkSelector "setRightMargin:") retVoid [argCDouble (fromIntegral value)]
...
setTopMargin nsPrintInfo  value =
  sendMsg nsPrintInfo (mkSelector "setTopMargin:") retVoid [argCDouble (fromIntegral value)]
...
setBottomMargin nsPrintInfo  value =
  sendMsg nsPrintInfo (mkSelector "setBottomMargin:") retVoid [argCDouble (fromIntegral value)]
