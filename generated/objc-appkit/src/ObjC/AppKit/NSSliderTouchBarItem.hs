...
setDoubleValue nsSliderTouchBarItem  value =
  sendMsg nsSliderTouchBarItem (mkSelector "setDoubleValue:") retVoid [argCDouble (fromIntegral value)]
...
setMinimumSliderWidth nsSliderTouchBarItem  value =
  sendMsg nsSliderTouchBarItem (mkSelector "setMinimumSliderWidth:") retVoid [argCDouble (fromIntegral value)]
...
setMaximumSliderWidth nsSliderTouchBarItem  value =
  sendMsg nsSliderTouchBarItem (mkSelector "setMaximumSliderWidth:") retVoid [argCDouble (fromIntegral value)]
...
setValueAccessoryWidth nsSliderTouchBarItem  value =
  sendMsg nsSliderTouchBarItem (mkSelector "setValueAccessoryWidth:") retVoid [argCDouble (fromIntegral value)]
