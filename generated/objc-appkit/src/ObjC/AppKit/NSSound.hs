...
setVolume nsSound  value =
  sendMsg nsSound (mkSelector "setVolume:") retVoid [argCFloat (fromIntegral value)]
...
setCurrentTime nsSound  value =
  sendMsg nsSound (mkSelector "setCurrentTime:") retVoid [argCDouble (fromIntegral value)]
