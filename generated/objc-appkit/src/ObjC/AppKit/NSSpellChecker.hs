...
withObjCPtr stringToCheck $ \raw_stringToCheck ->
  withObjCPtr language $ \raw_language ->
      sendMsgStret nsSpellChecker (mkSelector "checkSpellingOfString:startingAt:language:wrap:inSpellDocumentWithTag:wordCount:") retNSRange [argPtr (castPtr raw_stringToCheck :: Ptr ()), argCLong (fromIntegral startingOffset), argPtr (castPtr raw_language :: Ptr ()), argCULong (if wrapFlag then 1 else 0), argCLong (fromIntegral tag), argPtr wordCount]
...
withObjCPtr stringToCheck $ \raw_stringToCheck ->
    sendMsgStret nsSpellChecker (mkSelector "checkSpellingOfString:startingAt:") retNSRange [argPtr (castPtr raw_stringToCheck :: Ptr ()), argCLong (fromIntegral startingOffset)]
...
withObjCPtr stringToCheck $ \raw_stringToCheck ->
  withObjCPtr language $ \raw_language ->
    withObjCPtr details $ \raw_details ->
        sendMsgStret nsSpellChecker (mkSelector "checkGrammarOfString:startingAt:language:wrap:inSpellDocumentWithTag:details:") retNSRange [argPtr (castPtr raw_stringToCheck :: Ptr ()), argCLong (fromIntegral startingOffset), argPtr (castPtr raw_language :: Ptr ()), argCULong (if wrapFlag then 1 else 0), argCLong (fromIntegral tag), argPtr (castPtr raw_details :: Ptr ())]
...
withObjCPtr stringToCheck $ \raw_stringToCheck ->
  withObjCPtr options $ \raw_options ->
    withObjCPtr orthography $ \raw_orthography ->
        sendMsg nsSpellChecker (mkSelector "checkString:range:types:options:inSpellDocumentWithTag:orthography:wordCount:") (retPtr retVoid) [argPtr (castPtr raw_stringToCheck :: Ptr ()), argNSRange range, argCULong (fromIntegral checkingTypes), argPtr (castPtr raw_options :: Ptr ()), argCLong (fromIntegral tag), argPtr (castPtr raw_orthography :: Ptr ()), argPtr wordCount] >>= retainedObject . castPtr
...
withObjCPtr wordToIgnore $ \raw_wordToIgnore ->
    sendMsg nsSpellChecker (mkSelector "ignoreWord:inSpellDocumentWithTag:") retVoid [argPtr (castPtr raw_wordToIgnore :: Ptr ()), argCLong (fromIntegral tag)]
...
ignoredWordsInSpellDocumentWithTag nsSpellChecker  tag =
  sendMsg nsSpellChecker (mkSelector "ignoredWordsInSpellDocumentWithTag:") (retPtr retVoid) [argCLong (fromIntegral tag)] >>= retainedObject . castPtr
...
withObjCPtr words_ $ \raw_words_ ->
    sendMsg nsSpellChecker (mkSelector "setIgnoredWords:inSpellDocumentWithTag:") retVoid [argPtr (castPtr raw_words_ :: Ptr ()), argCLong (fromIntegral tag)]
...
withObjCPtr string $ \raw_string ->
  withObjCPtr language $ \raw_language ->
      sendMsg nsSpellChecker (mkSelector "guessesForWordRange:inString:language:inSpellDocumentWithTag:") (retPtr retVoid) [argNSRange range, argPtr (castPtr raw_string :: Ptr ()), argPtr (castPtr raw_language :: Ptr ()), argCLong (fromIntegral tag)] >>= retainedObject . castPtr
...
withObjCPtr string $ \raw_string ->
  withObjCPtr language $ \raw_language ->
      sendMsg nsSpellChecker (mkSelector "correctionForWordRange:inString:language:inSpellDocumentWithTag:") (retPtr retVoid) [argNSRange range, argPtr (castPtr raw_string :: Ptr ()), argPtr (castPtr raw_language :: Ptr ()), argCLong (fromIntegral tag)] >>= retainedObject . castPtr
...
withObjCPtr string $ \raw_string ->
  withObjCPtr language $ \raw_language ->
      sendMsg nsSpellChecker (mkSelector "completionsForPartialWordRange:inString:language:inSpellDocumentWithTag:") (retPtr retVoid) [argNSRange range, argPtr (castPtr raw_string :: Ptr ()), argPtr (castPtr raw_language :: Ptr ()), argCLong (fromIntegral tag)] >>= retainedObject . castPtr
...
closeSpellDocumentWithTag nsSpellChecker  tag =
  sendMsg nsSpellChecker (mkSelector "closeSpellDocumentWithTag:") retVoid [argCLong (fromIntegral tag)]
...
withObjCPtr correction $ \raw_correction ->
  withObjCPtr word $ \raw_word ->
    withObjCPtr language $ \raw_language ->
        sendMsg nsSpellChecker (mkSelector "recordResponse:toCorrection:forWord:language:inSpellDocumentWithTag:") retVoid [argCLong (coerce response), argPtr (castPtr raw_correction :: Ptr ()), argPtr (castPtr raw_word :: Ptr ()), argPtr (castPtr raw_language :: Ptr ()), argCLong (fromIntegral tag)]
