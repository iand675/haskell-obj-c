...
minPossiblePositionOfDividerAtIndex nsSplitView  dividerIndex =
  sendMsg nsSplitView (mkSelector "minPossiblePositionOfDividerAtIndex:") retCDouble [argCLong (fromIntegral dividerIndex)]
...
maxPossiblePositionOfDividerAtIndex nsSplitView  dividerIndex =
  sendMsg nsSplitView (mkSelector "maxPossiblePositionOfDividerAtIndex:") retCDouble [argCLong (fromIntegral dividerIndex)]
...
setPosition_ofDividerAtIndex nsSplitView  position dividerIndex =
  sendMsg nsSplitView (mkSelector "setPosition:ofDividerAtIndex:") retVoid [argCDouble (fromIntegral position), argCLong (fromIntegral dividerIndex)]
...
holdingPriorityForSubviewAtIndex nsSplitView  subviewIndex =
  sendMsg nsSplitView (mkSelector "holdingPriorityForSubviewAtIndex:") retCFloat [argCLong (fromIntegral subviewIndex)]
...
setHoldingPriority_forSubviewAtIndex nsSplitView  priority subviewIndex =
  sendMsg nsSplitView (mkSelector "setHoldingPriority:forSubviewAtIndex:") retVoid [argCFloat (fromIntegral priority), argCLong (fromIntegral subviewIndex)]
...
withObjCPtr view $ \raw_view ->
    sendMsg nsSplitView (mkSelector "insertArrangedSubview:atIndex:") retVoid [argPtr (castPtr raw_view :: Ptr ()), argCLong (fromIntegral index)]
