...
selectTabViewItemAtIndex nsTabView  index =
  sendMsg nsTabView (mkSelector "selectTabViewItemAtIndex:") retVoid [argCLong (fromIntegral index)]
...
withObjCPtr tabViewItem $ \raw_tabViewItem ->
    sendMsg nsTabView (mkSelector "insertTabViewItem:atIndex:") retVoid [argPtr (castPtr raw_tabViewItem :: Ptr ()), argCLong (fromIntegral index)]
...
tabViewItemAtIndex nsTabView  index =
  sendMsg nsTabView (mkSelector "tabViewItemAtIndex:") (retPtr retVoid) [argCLong (fromIntegral index)] >>= retainedObject . castPtr
