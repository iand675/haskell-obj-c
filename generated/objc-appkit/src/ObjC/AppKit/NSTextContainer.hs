...
setLineFragmentPadding nsTextContainer  value =
  sendMsg nsTextContainer (mkSelector "setLineFragmentPadding:") retVoid [argCDouble (fromIntegral value)]
...
setMaximumNumberOfLines nsTextContainer  value =
  sendMsg nsTextContainer (mkSelector "setMaximumNumberOfLines:") retVoid [argCULong (fromIntegral value)]
