...
setPreferredMaxLayoutWidth nsTextField  value =
  sendMsg nsTextField (mkSelector "setPreferredMaxLayoutWidth:") retVoid [argCDouble (fromIntegral value)]
...
setMaximumNumberOfLines nsTextField  value =
  sendMsg nsTextField (mkSelector "setMaximumNumberOfLines:") retVoid [argCLong (fromIntegral value)]
