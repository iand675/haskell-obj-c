...
withObjCPtr itemIdentifier $ \raw_itemIdentifier ->
    sendMsg nsToolbar (mkSelector "insertItemWithItemIdentifier:atIndex:") retVoid [argPtr (castPtr raw_itemIdentifier :: Ptr ()), argCLong (fromIntegral index)]
...
removeItemAtIndex nsToolbar  index =
  sendMsg nsToolbar (mkSelector "removeItemAtIndex:") retVoid [argCLong (fromIntegral index)]
...
setFullScreenAccessoryViewMinHeight nsToolbar  value =
  sendMsg nsToolbar (mkSelector "setFullScreenAccessoryViewMinHeight:") retVoid [argCDouble (fromIntegral value)]
...
setFullScreenAccessoryViewMaxHeight nsToolbar  value =
  sendMsg nsToolbar (mkSelector "setFullScreenAccessoryViewMaxHeight:") retVoid [argCDouble (fromIntegral value)]
