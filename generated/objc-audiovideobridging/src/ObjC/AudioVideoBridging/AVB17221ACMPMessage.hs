...
setStreamID avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setStreamID:") retVoid [argCULong (fromIntegral value)]
...
setControllerEntityID avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setControllerEntityID:") retVoid [argCULong (fromIntegral value)]
...
setTalkerEntityID avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setTalkerEntityID:") retVoid [argCULong (fromIntegral value)]
...
setListenerEntityID avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setListenerEntityID:") retVoid [argCULong (fromIntegral value)]
...
flags avB17221ACMPMessage  =
  fmap (coerce :: CUInt -> AVB17221ACMPFlags) $ sendMsg avB17221ACMPMessage (mkSelector "flags") retCUInt []
...
setFlags avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setFlags:") retVoid [argCUInt (coerce value)]
...
ipFlags avB17221ACMPMessage  =
  fmap (coerce :: CUInt -> AVB17221ACMPIPFlag) $ sendMsg avB17221ACMPMessage (mkSelector "ipFlags") retCUInt []
...
setIpFlags avB17221ACMPMessage  value =
  sendMsg avB17221ACMPMessage (mkSelector "setIpFlags:") retVoid [argCUInt (coerce value)]
