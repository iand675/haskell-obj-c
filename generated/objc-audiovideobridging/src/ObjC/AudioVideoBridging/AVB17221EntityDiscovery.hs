...
discoverEntity avB17221EntityDiscovery  entityID =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg avB17221EntityDiscovery (mkSelector "discoverEntity:") retCULong [argCULong (fromIntegral entityID)]
...
withObjCPtr error_ $ \raw_error_ ->
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg avB17221EntityDiscovery (mkSelector "removeLocalEntity:error:") retCULong [argCULong (fromIntegral guid), argPtr (castPtr raw_error_ :: Ptr ())]
...
withObjCPtr error_ $ \raw_error_ ->
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg avB17221EntityDiscovery (mkSelector "changeEntityWithEntityID:toNewGPTPGrandmasterID:error:") retCULong [argCULong (fromIntegral entityID), argCULong (fromIntegral gPTPGrandmasterID), argPtr (castPtr raw_error_ :: Ptr ())]
