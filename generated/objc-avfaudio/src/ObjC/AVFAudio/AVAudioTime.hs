...
initWithHostTime avAudioTime  hostTime =
  sendMsg avAudioTime (mkSelector "initWithHostTime:") (retPtr retVoid) [argCULong (fromIntegral hostTime)] >>= ownedObject . castPtr
...
initWithSampleTime_atRate avAudioTime  sampleTime sampleRate =
  sendMsg avAudioTime (mkSelector "initWithSampleTime:atRate:") (retPtr retVoid) [argCLong (fromIntegral sampleTime), argCDouble (fromIntegral sampleRate)] >>= ownedObject . castPtr
...
initWithHostTime_sampleTime_atRate avAudioTime  hostTime sampleTime sampleRate =
  sendMsg avAudioTime (mkSelector "initWithHostTime:sampleTime:atRate:") (retPtr retVoid) [argCULong (fromIntegral hostTime), argCLong (fromIntegral sampleTime), argCDouble (fromIntegral sampleRate)] >>= ownedObject . castPtr
...
timeWithHostTime hostTime =
  do
    ...
    sendClassMsg cls' (mkSelector "timeWithHostTime:") (retPtr retVoid) [argCULong (fromIntegral hostTime)] >>= retainedObject . castPtr
...
timeWithSampleTime_atRate sampleTime sampleRate =
  do
    cls' <- getRequiredClass "AVAudioTime"
    sendClassMsg cls' (mkSelector "timeWithSampleTime:atRate:") (retPtr retVoid) [argCLong (fromIntegral sampleTime), argCDouble (fromIntegral sampleRate)] >>= retainedObject . castPtr
...
timeWithHostTime_sampleTime_atRate hostTime sampleTime sampleRate =
  do
    cls' <- getRequiredClass "AVAudioTime"
    sendClassMsg cls' (mkSelector "timeWithHostTime:sampleTime:atRate:") (retPtr retVoid) [argCULong (fromIntegral hostTime), argCLong (fromIntegral sampleTime), argCDouble (fromIntegral sampleRate)] >>= retainedObject . castPtr
...
hostTimeForSeconds seconds =
  do
    cls' <- getRequiredClass "AVAudioTime"
    sendClassMsg cls' (mkSelector "hostTimeForSeconds:") retCULong [argCDouble (fromIntegral seconds)]
...
secondsForHostTime hostTime =
  do
    cls' <- getRequiredClass "AVAudioTime"
    sendClassMsg cls' (mkSelector "secondsForHostTime:") retCDouble [argCULong (fromIntegral hostTime)]
