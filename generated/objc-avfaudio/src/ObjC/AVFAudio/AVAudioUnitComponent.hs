...
supportsNumberInputChannels_outputChannels avAudioUnitComponent  numInputChannels numOutputChannels =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg avAudioUnitComponent (mkSelector "supportsNumberInputChannels:outputChannels:") retCULong [argCLong (fromIntegral numInputChannels), argCLong (fromIntegral numOutputChannels)]
