...
trackWithTrackID avAsset  trackID =
  sendMsg avAsset (mkSelector "trackWithTrackID:") (retPtr retVoid) [argCInt (fromIntegral trackID)] >>= retainedObject . castPtr
...
loadTrackWithTrackID_completionHandler avAsset  trackID completionHandler =
  sendMsg avAsset (mkSelector "loadTrackWithTrackID:completionHandler:") retVoid [argCInt (fromIntegral trackID), argPtr (castPtr completionHandler :: Ptr ())]
