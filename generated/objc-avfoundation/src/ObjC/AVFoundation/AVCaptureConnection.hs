...
isVideoRotationAngleSupported avCaptureConnection  videoRotationAngle =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg avCaptureConnection (mkSelector "isVideoRotationAngleSupported:") retCULong [argCDouble (fromIntegral videoRotationAngle)]
...
setVideoRotationAngle avCaptureConnection  value =
  sendMsg avCaptureConnection (mkSelector "setVideoRotationAngle:") retVoid [argCDouble (fromIntegral value)]
...
setVideoScaleAndCropFactor avCaptureConnection  value =
  sendMsg avCaptureConnection (mkSelector "setVideoScaleAndCropFactor:") retVoid [argCDouble (fromIntegral value)]
