...
setMaxRecordedFileSize avCaptureFileOutput  value =
  sendMsg avCaptureFileOutput (mkSelector "setMaxRecordedFileSize:") retVoid [argCLong (fromIntegral value)]
...
setMinFreeDiskSpaceLimit avCaptureFileOutput  value =
  sendMsg avCaptureFileOutput (mkSelector "setMinFreeDiskSpaceLimit:") retVoid [argCLong (fromIntegral value)]
