...
stopTrackingCaptureRequestUsingPhotoSettingsUniqueID avCapturePhotoOutputReadinessCoordinator  settingsUniqueID =
  sendMsg avCapturePhotoOutputReadinessCoordinator (mkSelector "stopTrackingCaptureRequestUsingPhotoSettingsUniqueID:") retVoid [argCLong (fromIntegral settingsUniqueID)]
