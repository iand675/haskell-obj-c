...
withObjCPtr localizedTitle $ \raw_localizedTitle ->
  withObjCPtr symbolName $ \raw_symbolName ->
      sendMsg avCaptureSlider (mkSelector "initWithLocalizedTitle:symbolName:minValue:maxValue:") (retPtr retVoid) [argPtr (castPtr raw_localizedTitle :: Ptr ()), argPtr (castPtr raw_symbolName :: Ptr ()), argCFloat (fromIntegral minValue), argCFloat (fromIntegral maxValue)] >>= ownedObject . castPtr
...
withObjCPtr localizedTitle $ \raw_localizedTitle ->
  withObjCPtr symbolName $ \raw_symbolName ->
      sendMsg avCaptureSlider (mkSelector "initWithLocalizedTitle:symbolName:minValue:maxValue:step:") (retPtr retVoid) [argPtr (castPtr raw_localizedTitle :: Ptr ()), argPtr (castPtr raw_symbolName :: Ptr ()), argCFloat (fromIntegral minValue), argCFloat (fromIntegral maxValue), argCFloat (fromIntegral step)] >>= ownedObject . castPtr
...
setValue avCaptureSlider  value =
  sendMsg avCaptureSlider (mkSelector "setValue:") retVoid [argCFloat (fromIntegral value)]
