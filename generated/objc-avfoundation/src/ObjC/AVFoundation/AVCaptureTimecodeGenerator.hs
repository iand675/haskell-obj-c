...
setSynchronizationTimeout avCaptureTimecodeGenerator  value =
  sendMsg avCaptureTimecodeGenerator (mkSelector "setSynchronizationTimeout:") retVoid [argCDouble (fromIntegral value)]
...
setTimecodeAlignmentOffset avCaptureTimecodeGenerator  value =
  sendMsg avCaptureTimecodeGenerator (mkSelector "setTimecodeAlignmentOffset:") retVoid [argCDouble (fromIntegral value)]
