...
trackWithTrackID avMovie  trackID =
  sendMsg avMovie (mkSelector "trackWithTrackID:") (retPtr retVoid) [argCInt (fromIntegral trackID)] >>= retainedObject . castPtr
...
loadTrackWithTrackID_completionHandler avMovie  trackID completionHandler =
  sendMsg avMovie (mkSelector "loadTrackWithTrackID:completionHandler:") retVoid [argCInt (fromIntegral trackID), argPtr (castPtr completionHandler :: Ptr ())]
