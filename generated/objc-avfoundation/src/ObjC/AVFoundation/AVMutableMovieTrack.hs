...
setAlternateGroupID avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setAlternateGroupID:") retVoid [argCLong (fromIntegral value)]
...
setTimescale avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setTimescale:") retVoid [argCInt (fromIntegral value)]
...
setPreferredMediaChunkSize avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setPreferredMediaChunkSize:") retVoid [argCLong (fromIntegral value)]
...
setPreferredMediaChunkAlignment avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setPreferredMediaChunkAlignment:") retVoid [argCLong (fromIntegral value)]
...
setPreferredVolume avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setPreferredVolume:") retVoid [argCFloat (fromIntegral value)]
...
setLayer avMutableMovieTrack  value =
  sendMsg avMutableMovieTrack (mkSelector "setLayer:") retVoid [argCLong (fromIntegral value)]
