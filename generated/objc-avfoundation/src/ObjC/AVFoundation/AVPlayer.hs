...
prerollAtRate_completionHandler avPlayer  rate completionHandler =
  sendMsg avPlayer (mkSelector "prerollAtRate:completionHandler:") retVoid [argCFloat (fromIntegral rate), argPtr (castPtr completionHandler :: Ptr ())]
...
playImmediatelyAtRate avPlayer  rate =
  sendMsg avPlayer (mkSelector "playImmediatelyAtRate:") retVoid [argCFloat (fromIntegral rate)]
...
setPreferredVideoDecoderGPURegistryID avPlayer  value =
  sendMsg avPlayer (mkSelector "setPreferredVideoDecoderGPURegistryID:") retVoid [argCULong (fromIntegral value)]
...
setVolume avPlayer  value =
  sendMsg avPlayer (mkSelector "setVolume:") retVoid [argCFloat (fromIntegral value)]
...
setRate avPlayer  value =
  sendMsg avPlayer (mkSelector "setRate:") retVoid [argCFloat (fromIntegral value)]
...
setDefaultRate avPlayer  value =
  sendMsg avPlayer (mkSelector "setDefaultRate:") retVoid [argCFloat (fromIntegral value)]
