...
videoCompositionCoreAnimationToolWithAdditionalLayer_asTrackID layer trackID =
  do
    ...
    withObjCPtr layer $ \raw_layer ->
      sendClassMsg cls' (mkSelector "videoCompositionCoreAnimationToolWithAdditionalLayer:asTrackID:") (retPtr retVoid) [argPtr (castPtr raw_layer :: Ptr ()), argCInt (fromIntegral trackID)] >>= retainedObject . castPtr
