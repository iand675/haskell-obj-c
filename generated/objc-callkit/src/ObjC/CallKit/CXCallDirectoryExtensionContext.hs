...
addBlockingEntryWithNextSequentialPhoneNumber cxCallDirectoryExtensionContext  phoneNumber =
  sendMsg cxCallDirectoryExtensionContext (mkSelector "addBlockingEntryWithNextSequentialPhoneNumber:") retVoid [argCLong (fromIntegral phoneNumber)]
...
removeBlockingEntryWithPhoneNumber cxCallDirectoryExtensionContext  phoneNumber =
  sendMsg cxCallDirectoryExtensionContext (mkSelector "removeBlockingEntryWithPhoneNumber:") retVoid [argCLong (fromIntegral phoneNumber)]
...
withObjCPtr label $ \raw_label ->
    sendMsg cxCallDirectoryExtensionContext (mkSelector "addIdentificationEntryWithNextSequentialPhoneNumber:label:") retVoid [argCLong (fromIntegral phoneNumber), argPtr (castPtr raw_label :: Ptr ())]
...
removeIdentificationEntryWithPhoneNumber cxCallDirectoryExtensionContext  phoneNumber =
  sendMsg cxCallDirectoryExtensionContext (mkSelector "removeIdentificationEntryWithPhoneNumber:") retVoid [argCLong (fromIntegral phoneNumber)]
