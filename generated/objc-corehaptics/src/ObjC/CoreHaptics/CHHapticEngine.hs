...
withObjCPtr outError $ \raw_outError ->
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg chHapticEngine (mkSelector "unregisterAudioResource:error:") retCULong [argCULong (fromIntegral resourceID), argPtr (castPtr raw_outError :: Ptr ())]
