...
imageWithCGImageSource_index_options source index dict =
  do
    ...
    withObjCPtr dict $ \raw_dict ->
      sendClassMsg cls' (mkSelector "imageWithCGImageSource:index:options:") (retPtr retVoid) [argPtr source, argCULong (fromIntegral index), argPtr (castPtr raw_dict :: Ptr ())] >>= retainedObject . castPtr
...
withObjCPtr dict $ \raw_dict ->
    sendMsg ciImage (mkSelector "initWithCGImageSource:index:options:") (retPtr retVoid) [argPtr source, argCULong (fromIntegral index), argPtr (castPtr raw_dict :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr options $ \raw_options ->
    sendMsg ciImage (mkSelector "initWithIOSurface:plane:format:options:") (retPtr retVoid) [argPtr surface, argCULong (fromIntegral plane), argCInt (fromIntegral format), argPtr (castPtr raw_options :: Ptr ())] >>= ownedObject . castPtr
...
imageByApplyingOrientation ciImage  orientation =
  sendMsg ciImage (mkSelector "imageByApplyingOrientation:") (retPtr retVoid) [argCInt (fromIntegral orientation)] >>= retainedObject . castPtr
...
imageByApplyingGaussianBlurWithSigma ciImage  sigma =
  sendMsg ciImage (mkSelector "imageByApplyingGaussianBlurWithSigma:") (retPtr retVoid) [argCDouble (fromIntegral sigma)] >>= retainedObject . castPtr
...
withObjCPtr gainmap $ \raw_gainmap ->
    sendMsg ciImage (mkSelector "imageByApplyingGainMap:headroom:") (retPtr retVoid) [argPtr (castPtr raw_gainmap :: Ptr ()), argCFloat (fromIntegral headroom)] >>= retainedObject . castPtr
...
imageBySettingContentHeadroom ciImage  headroom =
  sendMsg ciImage (mkSelector "imageBySettingContentHeadroom:") (retPtr retVoid) [argCFloat (fromIntegral headroom)] >>= retainedObject . castPtr
...
imageBySettingContentAverageLightLevel ciImage  average =
  sendMsg ciImage (mkSelector "imageBySettingContentAverageLightLevel:") (retPtr retVoid) [argCFloat (fromIntegral average)] >>= retainedObject . castPtr
...
imageWithImageProvider_size__format_colorSpace_options provider width height format colorSpace options =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr options $ \raw_options ->
      sendClassMsg cls' (mkSelector "imageWithImageProvider:size::format:colorSpace:options:") (retPtr retVoid) [argPtr (castPtr (unRawId provider) :: Ptr ()), argCULong (fromIntegral width), argCULong (fromIntegral height), argCInt (fromIntegral format), argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr
...
withObjCPtr options $ \raw_options ->
    sendMsg ciImage (mkSelector "initWithImageProvider:size::format:colorSpace:options:") (retPtr retVoid) [argPtr (castPtr (unRawId provider) :: Ptr ()), argCULong (fromIntegral width), argCULong (fromIntegral height), argCInt (fromIntegral format), argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ())] >>= ownedObject . castPtr

-- | @- initWithSemanticSegmentationMatte:options:@
initWithSemanticSegmentationMatte_options :: (IsCIImage ciImage, IsAVSemanticSegmentationMatte matte, IsNSDictionary options) => ciImage -> matte -> options -> IO (Id CIImage)
initWithSemanticSegmentationMatte_options ciImage  matte options =
withObjCPtr matte $ \raw_matte ->
  withObjCPtr options $ \raw_options ->
      sendMsg ciImage (mkSelector "initWithSemanticSegmentationMatte:options:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= ownedObject . castPtr

-- | @- initWithSemanticSegmentationMatte:@
initWithSemanticSegmentationMatte :: (IsCIImage ciImage, IsAVSemanticSegmentationMatte matte) => ciImage -> matte -> IO (Id CIImage)
initWithSemanticSegmentationMatte ciImage  matte =
withObjCPtr matte $ \raw_matte ->
    sendMsg ciImage (mkSelector "initWithSemanticSegmentationMatte:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ())] >>= ownedObject . castPtr

-- | @+ imageWithSemanticSegmentationMatte:options:@
imageWithSemanticSegmentationMatte_options :: (IsAVSemanticSegmentationMatte matte, IsNSDictionary options) => matte -> options -> IO (Id CIImage)
imageWithSemanticSegmentationMatte_options matte options =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr matte $ \raw_matte ->
      withObjCPtr options $ \raw_options ->
        sendClassMsg cls' (mkSelector "imageWithSemanticSegmentationMatte:options:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr

-- | @+ imageWithSemanticSegmentationMatte:@
imageWithSemanticSegmentationMatte :: IsAVSemanticSegmentationMatte matte => matte -> IO (Id CIImage)
imageWithSemanticSegmentationMatte matte =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr matte $ \raw_matte ->
      sendClassMsg cls' (mkSelector "imageWithSemanticSegmentationMatte:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ())] >>= retainedObject . castPtr

-- | @- initWithPortaitEffectsMatte:options:@
initWithPortaitEffectsMatte_options :: (IsCIImage ciImage, IsAVPortraitEffectsMatte matte, IsNSDictionary options) => ciImage -> matte -> options -> IO (Id CIImage)
initWithPortaitEffectsMatte_options ciImage  matte options =
withObjCPtr matte $ \raw_matte ->
  withObjCPtr options $ \raw_options ->
      sendMsg ciImage (mkSelector "initWithPortaitEffectsMatte:options:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= ownedObject . castPtr

-- | @- initWithPortaitEffectsMatte:@
initWithPortaitEffectsMatte :: (IsCIImage ciImage, IsAVPortraitEffectsMatte matte) => ciImage -> matte -> IO (Id CIImage)
initWithPortaitEffectsMatte ciImage  matte =
withObjCPtr matte $ \raw_matte ->
    sendMsg ciImage (mkSelector "initWithPortaitEffectsMatte:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ())] >>= ownedObject . castPtr

-- | @+ imageWithPortaitEffectsMatte:options:@
imageWithPortaitEffectsMatte_options :: (IsAVPortraitEffectsMatte matte, IsNSDictionary options) => matte -> options -> IO (Id CIImage)
imageWithPortaitEffectsMatte_options matte options =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr matte $ \raw_matte ->
      withObjCPtr options $ \raw_options ->
        sendClassMsg cls' (mkSelector "imageWithPortaitEffectsMatte:options:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr

-- | @+ imageWithPortaitEffectsMatte:@
imageWithPortaitEffectsMatte :: IsAVPortraitEffectsMatte matte => matte -> IO (Id CIImage)
imageWithPortaitEffectsMatte matte =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr matte $ \raw_matte ->
      sendClassMsg cls' (mkSelector "imageWithPortaitEffectsMatte:") (retPtr retVoid) [argPtr (castPtr raw_matte :: Ptr ())] >>= retainedObject . castPtr

-- | @- initWithDepthData:options:@
initWithDepthData_options :: (IsCIImage ciImage, IsAVDepthData data_, IsNSDictionary options) => ciImage -> data_ -> options -> IO (Id CIImage)
initWithDepthData_options ciImage  data_ options =
withObjCPtr data_ $ \raw_data_ ->
  withObjCPtr options $ \raw_options ->
      sendMsg ciImage (mkSelector "initWithDepthData:options:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= ownedObject . castPtr

-- | @- initWithDepthData:@
initWithDepthData :: (IsCIImage ciImage, IsAVDepthData data_) => ciImage -> data_ -> IO (Id CIImage)
initWithDepthData ciImage  data_ =
withObjCPtr data_ $ \raw_data_ ->
    sendMsg ciImage (mkSelector "initWithDepthData:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ())] >>= ownedObject . castPtr

-- | @+ imageWithDepthData:options:@
imageWithDepthData_options :: (IsAVDepthData data_, IsNSDictionary options) => data_ -> options -> IO (Id CIImage)
imageWithDepthData_options data_ options =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr data_ $ \raw_data_ ->
      withObjCPtr options $ \raw_options ->
        sendClassMsg cls' (mkSelector "imageWithDepthData:options:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ()), argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr

-- | @+ imageWithDepthData:@
imageWithDepthData :: IsAVDepthData data_ => data_ -> IO (Id CIImage)
imageWithDepthData data_ =
  do
    cls' <- getRequiredClass "CIImage"
    withObjCPtr data_ $ \raw_data_ ->
      sendClassMsg cls' (mkSelector "imageWithDepthData:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ())] >>= retainedObject . castPtr
