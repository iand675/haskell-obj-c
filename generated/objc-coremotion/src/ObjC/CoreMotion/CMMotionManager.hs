...
setAccelerometerUpdateInterval cmMotionManager  value =
  sendMsg cmMotionManager (mkSelector "setAccelerometerUpdateInterval:") retVoid [argCDouble (fromIntegral value)]
...
setGyroUpdateInterval cmMotionManager  value =
  sendMsg cmMotionManager (mkSelector "setGyroUpdateInterval:") retVoid [argCDouble (fromIntegral value)]
...
setMagnetometerUpdateInterval cmMotionManager  value =
  sendMsg cmMotionManager (mkSelector "setMagnetometerUpdateInterval:") retVoid [argCDouble (fromIntegral value)]
...
setDeviceMotionUpdateInterval cmMotionManager  value =
  sendMsg cmMotionManager (mkSelector "setDeviceMotionUpdateInterval:") retVoid [argCDouble (fromIntegral value)]
