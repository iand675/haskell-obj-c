...
setInitialTimeout tkSmartCardUserInteraction  value =
  sendMsg tkSmartCardUserInteraction (mkSelector "setInitialTimeout:") retVoid [argCDouble (fromIntegral value)]
...
setInteractionTimeout tkSmartCardUserInteraction  value =
  sendMsg tkSmartCardUserInteraction (mkSelector "setInteractionTimeout:") retVoid [argCDouble (fromIntegral value)]
