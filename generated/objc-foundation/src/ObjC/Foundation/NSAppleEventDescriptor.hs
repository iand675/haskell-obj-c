...
descriptorWithDescriptorType_bytes_length descriptorType bytes byteCount =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithDescriptorType:bytes:length:") (retPtr retVoid) [argCUInt (fromIntegral descriptorType), argPtr (unConst bytes), argCULong (fromIntegral byteCount)] >>= retainedObject . castPtr
...
descriptorWithDescriptorType_data descriptorType data_ =
  do
    ...
    withObjCPtr data_ $ \raw_data_ ->
      sendClassMsg cls' (mkSelector "descriptorWithDescriptorType:data:") (retPtr retVoid) [argCUInt (fromIntegral descriptorType), argPtr (castPtr raw_data_ :: Ptr ())] >>= retainedObject . castPtr
...
descriptorWithBoolean boolean =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithBoolean:") (retPtr retVoid) [argCUChar (fromIntegral boolean)] >>= retainedObject . castPtr
...
descriptorWithEnumCode enumerator =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithEnumCode:") (retPtr retVoid) [argCUInt (fromIntegral enumerator)] >>= retainedObject . castPtr
...
descriptorWithInt32 signedInt =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithInt32:") (retPtr retVoid) [argCInt (fromIntegral signedInt)] >>= retainedObject . castPtr
...
descriptorWithDouble doubleValue =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithDouble:") (retPtr retVoid) [argCDouble (fromIntegral doubleValue)] >>= retainedObject . castPtr
...
descriptorWithTypeCode typeCode =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithTypeCode:") (retPtr retVoid) [argCUInt (fromIntegral typeCode)] >>= retainedObject . castPtr
...
appleEventWithEventClass_eventID_targetDescriptor_returnID_transactionID eventClass eventID targetDescriptor returnID transactionID =
  do
    ...
    withObjCPtr targetDescriptor $ \raw_targetDescriptor ->
      sendClassMsg cls' (mkSelector "appleEventWithEventClass:eventID:targetDescriptor:returnID:transactionID:") (retPtr retVoid) [argCUInt (fromIntegral eventClass), argCUInt (fromIntegral eventID), argPtr (castPtr raw_targetDescriptor :: Ptr ()), argCInt (fromIntegral returnID), argCInt (fromIntegral transactionID)] >>= retainedObject . castPtr
...
descriptorWithProcessIdentifier processIdentifier =
  do
    cls' <- getRequiredClass "NSAppleEventDescriptor"
    sendClassMsg cls' (mkSelector "descriptorWithProcessIdentifier:") (retPtr retVoid) [argCInt (fromIntegral processIdentifier)] >>= retainedObject . castPtr
...
initWithDescriptorType_bytes_length nsAppleEventDescriptor  descriptorType bytes byteCount =
  sendMsg nsAppleEventDescriptor (mkSelector "initWithDescriptorType:bytes:length:") (retPtr retVoid) [argCUInt (fromIntegral descriptorType), argPtr (unConst bytes), argCULong (fromIntegral byteCount)] >>= ownedObject . castPtr
...
withObjCPtr data_ $ \raw_data_ ->
    sendMsg nsAppleEventDescriptor (mkSelector "initWithDescriptorType:data:") (retPtr retVoid) [argCUInt (fromIntegral descriptorType), argPtr (castPtr raw_data_ :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr targetDescriptor $ \raw_targetDescriptor ->
    sendMsg nsAppleEventDescriptor (mkSelector "initWithEventClass:eventID:targetDescriptor:returnID:transactionID:") (retPtr retVoid) [argCUInt (fromIntegral eventClass), argCUInt (fromIntegral eventID), argPtr (castPtr raw_targetDescriptor :: Ptr ()), argCInt (fromIntegral returnID), argCInt (fromIntegral transactionID)] >>= ownedObject . castPtr
...
withObjCPtr descriptor $ \raw_descriptor ->
    sendMsg nsAppleEventDescriptor (mkSelector "setParamDescriptor:forKeyword:") retVoid [argPtr (castPtr raw_descriptor :: Ptr ()), argCUInt (fromIntegral keyword)]
...
paramDescriptorForKeyword nsAppleEventDescriptor  keyword =
  sendMsg nsAppleEventDescriptor (mkSelector "paramDescriptorForKeyword:") (retPtr retVoid) [argCUInt (fromIntegral keyword)] >>= retainedObject . castPtr
...
removeParamDescriptorWithKeyword nsAppleEventDescriptor  keyword =
  sendMsg nsAppleEventDescriptor (mkSelector "removeParamDescriptorWithKeyword:") retVoid [argCUInt (fromIntegral keyword)]
...
withObjCPtr descriptor $ \raw_descriptor ->
    sendMsg nsAppleEventDescriptor (mkSelector "setAttributeDescriptor:forKeyword:") retVoid [argPtr (castPtr raw_descriptor :: Ptr ()), argCUInt (fromIntegral keyword)]
...
attributeDescriptorForKeyword nsAppleEventDescriptor  keyword =
  sendMsg nsAppleEventDescriptor (mkSelector "attributeDescriptorForKeyword:") (retPtr retVoid) [argCUInt (fromIntegral keyword)] >>= retainedObject . castPtr
...
withObjCPtr error_ $ \raw_error_ ->
    sendMsg nsAppleEventDescriptor (mkSelector "sendEventWithOptions:timeout:error:") (retPtr retVoid) [argCULong (coerce sendOptions), argCDouble (fromIntegral timeoutInSeconds), argPtr (castPtr raw_error_ :: Ptr ())] >>= retainedObject . castPtr
...
withObjCPtr descriptor $ \raw_descriptor ->
    sendMsg nsAppleEventDescriptor (mkSelector "insertDescriptor:atIndex:") retVoid [argPtr (castPtr raw_descriptor :: Ptr ()), argCLong (fromIntegral index)]
...
descriptorAtIndex nsAppleEventDescriptor  index =
  sendMsg nsAppleEventDescriptor (mkSelector "descriptorAtIndex:") (retPtr retVoid) [argCLong (fromIntegral index)] >>= retainedObject . castPtr
...
removeDescriptorAtIndex nsAppleEventDescriptor  index =
  sendMsg nsAppleEventDescriptor (mkSelector "removeDescriptorAtIndex:") retVoid [argCLong (fromIntegral index)]
...
withObjCPtr descriptor $ \raw_descriptor ->
    sendMsg nsAppleEventDescriptor (mkSelector "setDescriptor:forKeyword:") retVoid [argPtr (castPtr raw_descriptor :: Ptr ()), argCUInt (fromIntegral keyword)]
...
descriptorForKeyword nsAppleEventDescriptor  keyword =
  sendMsg nsAppleEventDescriptor (mkSelector "descriptorForKeyword:") (retPtr retVoid) [argCUInt (fromIntegral keyword)] >>= retainedObject . castPtr
...
removeDescriptorWithKeyword nsAppleEventDescriptor  keyword =
  sendMsg nsAppleEventDescriptor (mkSelector "removeDescriptorWithKeyword:") retVoid [argCUInt (fromIntegral keyword)]
...
keywordForDescriptorAtIndex nsAppleEventDescriptor  index =
  sendMsg nsAppleEventDescriptor (mkSelector "keywordForDescriptorAtIndex:") retCUInt [argCLong (fromIntegral index)]
...
coerceToDescriptorType nsAppleEventDescriptor  descriptorType =
  sendMsg nsAppleEventDescriptor (mkSelector "coerceToDescriptorType:") (retPtr retVoid) [argCUInt (fromIntegral descriptorType)] >>= retainedObject . castPtr
