...
setEventHandler_andSelector_forEventClass_andEventID nsAppleEventManager  handler handleEventSelector eventClass eventID =
  sendMsg nsAppleEventManager (mkSelector "setEventHandler:andSelector:forEventClass:andEventID:") retVoid [argPtr (castPtr (unRawId handler) :: Ptr ()), argPtr (unSelector handleEventSelector), argCUInt (fromIntegral eventClass), argCUInt (fromIntegral eventID)]
...
removeEventHandlerForEventClass_andEventID nsAppleEventManager  eventClass eventID =
  sendMsg nsAppleEventManager (mkSelector "removeEventHandlerForEventClass:andEventID:") retVoid [argCUInt (fromIntegral eventClass), argCUInt (fromIntegral eventID)]
