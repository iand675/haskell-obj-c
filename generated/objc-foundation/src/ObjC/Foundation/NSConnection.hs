...
setRequestTimeout nsConnection  value =
  sendMsg nsConnection (mkSelector "setRequestTimeout:") retVoid [argCDouble (fromIntegral value)]
...
setReplyTimeout nsConnection  value =
  sendMsg nsConnection (mkSelector "setReplyTimeout:") retVoid [argCDouble (fromIntegral value)]
