...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeInt:forKey:") retVoid [argCInt (fromIntegral value), argPtr (castPtr raw_key :: Ptr ())]
...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeInt32:forKey:") retVoid [argCInt (fromIntegral value), argPtr (castPtr raw_key :: Ptr ())]
...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeInt64:forKey:") retVoid [argCLong (fromIntegral value), argPtr (castPtr raw_key :: Ptr ())]
...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeFloat:forKey:") retVoid [argCFloat (fromIntegral value), argPtr (castPtr raw_key :: Ptr ())]
...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeDouble:forKey:") retVoid [argCDouble (fromIntegral value), argPtr (castPtr raw_key :: Ptr ())]
...
withObjCPtr key $ \raw_key ->
    sendMsg nsKeyedArchiver (mkSelector "encodeBytes:length:forKey:") retVoid [argPtr (unConst bytes), argCULong (fromIntegral length_), argPtr (castPtr raw_key :: Ptr ())]
