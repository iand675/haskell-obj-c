  ...
  do
    ...
    withObjCPtr inputStream $ \raw_inputStream ->
      withObjCPtr outputStream $ \raw_outputStream ->
        sendClassMsg cls' (mkSelector "getBoundStreamsWithBufferSize:inputStream:outputStream:") retVoid [argCULong (fromIntegral bufferSize), argPtr (castPtr raw_inputStream :: Ptr ()), argPtr (castPtr raw_outputStream :: Ptr ())]
...
getStreamsToHostWithName_port_inputStream_outputStream hostname port inputStream outputStream =
  do
    ...
    withObjCPtr hostname $ \raw_hostname ->
      withObjCPtr inputStream $ \raw_inputStream ->
        withObjCPtr outputStream $ \raw_outputStream ->
          sendClassMsg cls' (mkSelector "getStreamsToHostWithName:port:inputStream:outputStream:") retVoid [argPtr (castPtr raw_hostname :: Ptr ()), argCLong (fromIntegral port), argPtr (castPtr raw_inputStream :: Ptr ()), argPtr (castPtr raw_outputStream :: Ptr ())]
...
getStreamsToHost_port_inputStream_outputStream host port inputStream outputStream =
  do
    ...
    withObjCPtr host $ \raw_host ->
      withObjCPtr inputStream $ \raw_inputStream ->
        withObjCPtr outputStream $ \raw_outputStream ->
          sendClassMsg cls' (mkSelector "getStreamsToHost:port:inputStream:outputStream:") retVoid [argPtr (castPtr raw_host :: Ptr ()), argCLong (fromIntegral port), argPtr (castPtr raw_inputStream :: Ptr ()), argPtr (castPtr raw_outputStream :: Ptr ())]
