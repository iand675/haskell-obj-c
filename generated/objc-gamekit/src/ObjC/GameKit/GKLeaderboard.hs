  ...
  do
    ...
    withObjCPtr player $ \raw_player ->
      withObjCPtr leaderboardIDs $ \raw_leaderboardIDs ->
        sendClassMsg cls' (mkSelector "submitScore:context:player:leaderboardIDs:completionHandler:") retVoid [argCLong (fromIntegral score), argCULong (fromIntegral context), argPtr (castPtr raw_player :: Ptr ()), argPtr (castPtr raw_leaderboardIDs :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr player $ \raw_player ->
    sendMsg gkLeaderboard (mkSelector "submitScore:context:player:completionHandler:") retVoid [argCLong (fromIntegral score), argCULong (fromIntegral context), argPtr (castPtr raw_player :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
