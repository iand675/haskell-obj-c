...
setMinPlayers gkMatchRequest  value =
  sendMsg gkMatchRequest (mkSelector "setMinPlayers:") retVoid [argCULong (fromIntegral value)]
...
setMaxPlayers gkMatchRequest  value =
  sendMsg gkMatchRequest (mkSelector "setMaxPlayers:") retVoid [argCULong (fromIntegral value)]
...
setPlayerGroup gkMatchRequest  value =
  sendMsg gkMatchRequest (mkSelector "setPlayerGroup:") retVoid [argCULong (fromIntegral value)]
...
setPlayerAttributes gkMatchRequest  value =
  sendMsg gkMatchRequest (mkSelector "setPlayerAttributes:") retVoid [argCUInt (fromIntegral value)]
...
setDefaultNumberOfPlayers gkMatchRequest  value =
  sendMsg gkMatchRequest (mkSelector "setDefaultNumberOfPlayers:") retVoid [argCULong (fromIntegral value)]
