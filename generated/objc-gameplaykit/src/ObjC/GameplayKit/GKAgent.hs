...
setMass gkAgent  value =
  sendMsg gkAgent (mkSelector "setMass:") retVoid [argCFloat (fromIntegral value)]
...
setRadius gkAgent  value =
  sendMsg gkAgent (mkSelector "setRadius:") retVoid [argCFloat (fromIntegral value)]
...
setSpeed gkAgent  value =
  sendMsg gkAgent (mkSelector "setSpeed:") retVoid [argCFloat (fromIntegral value)]
...
setMaxAcceleration gkAgent  value =
  sendMsg gkAgent (mkSelector "setMaxAcceleration:") retVoid [argCFloat (fromIntegral value)]
...
setMaxSpeed gkAgent  value =
  sendMsg gkAgent (mkSelector "setMaxSpeed:") retVoid [argCFloat (fromIntegral value)]
