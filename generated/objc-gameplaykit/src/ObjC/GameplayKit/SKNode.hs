...
obstaclesFromSpriteTextures_accuracy sprites accuracy =
  do
    ...
    withObjCPtr sprites $ \raw_sprites ->
      sendClassMsg cls' (mkSelector "obstaclesFromSpriteTextures:accuracy:") (retPtr retVoid) [argPtr (castPtr raw_sprites :: Ptr ()), argCFloat (fromIntegral accuracy)] >>= retainedObject . castPtr
