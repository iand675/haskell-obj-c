...
--
-- Generated bindings for @ICScannerFunctionalUnitPositiveTransparency@.
module ObjC.ImageCaptureCore.ICScannerFunctionalUnitPositiveTransparency
  ( ICScannerFunctionalUnitPositiveTransparency
  , IsICScannerFunctionalUnitPositiveTransparency(..)
