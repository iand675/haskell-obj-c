...
withObjCPtr indicatorName $ \raw_indicatorName ->
    sendMsg ioBluetoothHandsFree (mkSelector "setIndicator:value:") retVoid [argPtr (castPtr raw_indicatorName :: Ptr ()), argCInt (fromIntegral indicatorValue)]
...
setSupportedFeatures ioBluetoothHandsFree  value =
  sendMsg ioBluetoothHandsFree (mkSelector "setSupportedFeatures:") retVoid [argCUInt (fromIntegral value)]
...
setInputVolume ioBluetoothHandsFree  value =
  sendMsg ioBluetoothHandsFree (mkSelector "setInputVolume:") retVoid [argCFloat (fromIntegral value)]
...
setOutputVolume ioBluetoothHandsFree  value =
  sendMsg ioBluetoothHandsFree (mkSelector "setOutputVolume:") retVoid [argCFloat (fromIntegral value)]
