...
setDisplayPriority mkAnnotationView  value =
  sendMsg mkAnnotationView (mkSelector "setDisplayPriority:") retVoid [argCFloat (fromIntegral value)]
...
setZPriority mkAnnotationView  value =
  sendMsg mkAnnotationView (mkSelector "setZPriority:") retVoid [argCFloat (fromIntegral value)]
...
setSelectedZPriority mkAnnotationView  value =
  sendMsg mkAnnotationView (mkSelector "setSelectedZPriority:") retVoid [argCFloat (fromIntegral value)]
