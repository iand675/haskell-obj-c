...
setAlpha mkOverlayRenderer  value =
  sendMsg mkOverlayRenderer (mkSelector "setAlpha:") retVoid [argCDouble (fromIntegral value)]
...
-- | @- blendMode@
blendMode :: IsMKOverlayRenderer mkOverlayRenderer => mkOverlayRenderer -> IO CGBlendMode
blendMode mkOverlayRenderer  =
  fmap (coerce :: CInt -> CGBlendMode) $ sendMsg mkOverlayRenderer (mkSelector "blendMode") retCInt []

-- | @- setBlendMode:@
setBlendMode :: IsMKOverlayRenderer mkOverlayRenderer => mkOverlayRenderer -> CGBlendMode -> IO ()
setBlendMode mkOverlayRenderer  value =
  sendMsg mkOverlayRenderer (mkSelector "setBlendMode:") retVoid [argCInt (coerce value)]
