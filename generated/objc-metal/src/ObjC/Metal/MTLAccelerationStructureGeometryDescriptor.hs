...
setIntersectionFunctionTableOffset mtlAccelerationStructureGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureGeometryDescriptor (mkSelector "setIntersectionFunctionTableOffset:") retVoid [argCULong (fromIntegral value)]
...
setPrimitiveDataBufferOffset mtlAccelerationStructureGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureGeometryDescriptor (mkSelector "setPrimitiveDataBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setPrimitiveDataStride mtlAccelerationStructureGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureGeometryDescriptor (mkSelector "setPrimitiveDataStride:") retVoid [argCULong (fromIntegral value)]
...
setPrimitiveDataElementSize mtlAccelerationStructureGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureGeometryDescriptor (mkSelector "setPrimitiveDataElementSize:") retVoid [argCULong (fromIntegral value)]
