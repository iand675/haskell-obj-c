...
setStartOfEncoderSampleIndex mtlAccelerationStructurePassSampleBufferAttachmentDescriptor  value =
  sendMsg mtlAccelerationStructurePassSampleBufferAttachmentDescriptor (mkSelector "setStartOfEncoderSampleIndex:") retVoid [argCULong (fromIntegral value)]
...
setEndOfEncoderSampleIndex mtlAccelerationStructurePassSampleBufferAttachmentDescriptor  value =
  sendMsg mtlAccelerationStructurePassSampleBufferAttachmentDescriptor (mkSelector "setEndOfEncoderSampleIndex:") retVoid [argCULong (fromIntegral value)]
