...
setVertexBufferOffset mtlAccelerationStructureTriangleGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureTriangleGeometryDescriptor (mkSelector "setVertexBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setVertexStride mtlAccelerationStructureTriangleGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureTriangleGeometryDescriptor (mkSelector "setVertexStride:") retVoid [argCULong (fromIntegral value)]
...
setIndexBufferOffset mtlAccelerationStructureTriangleGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureTriangleGeometryDescriptor (mkSelector "setIndexBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setTriangleCount mtlAccelerationStructureTriangleGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureTriangleGeometryDescriptor (mkSelector "setTriangleCount:") retVoid [argCULong (fromIntegral value)]
...
setTransformationMatrixBufferOffset mtlAccelerationStructureTriangleGeometryDescriptor  value =
  sendMsg mtlAccelerationStructureTriangleGeometryDescriptor (mkSelector "setTransformationMatrixBufferOffset:") retVoid [argCULong (fromIntegral value)]
