...
mutability mtlPipelineBufferDescriptor  =
  fmap (coerce :: CULong -> MTLMutability) $ sendMsg mtlPipelineBufferDescriptor (mkSelector "mutability") retCULong []
...
setMutability mtlPipelineBufferDescriptor  value =
  sendMsg mtlPipelineBufferDescriptor (mkSelector "setMutability:") retVoid [argCULong (coerce value)]
