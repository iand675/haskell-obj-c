...
withObjCPtr name $ \raw_name ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
        sendMsg mtkTextureLoader (mkSelector "newTextureWithName:scaleFactor:bundle:options:completionHandler:") retVoid [argPtr (castPtr raw_name :: Ptr ()), argCDouble (fromIntegral scaleFactor), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr name $ \raw_name ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
        sendMsg mtkTextureLoader (mkSelector "newTextureWithName:scaleFactor:displayGamut:bundle:options:completionHandler:") retVoid [argPtr (castPtr raw_name :: Ptr ()), argCDouble (fromIntegral scaleFactor), argCLong (coerce displayGamut), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr names $ \raw_names ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
        sendMsg mtkTextureLoader (mkSelector "newTexturesWithNames:scaleFactor:bundle:options:completionHandler:") retVoid [argPtr (castPtr raw_names :: Ptr ()), argCDouble (fromIntegral scaleFactor), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr names $ \raw_names ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
        sendMsg mtkTextureLoader (mkSelector "newTexturesWithNames:scaleFactor:displayGamut:bundle:options:completionHandler:") retVoid [argPtr (castPtr raw_names :: Ptr ()), argCDouble (fromIntegral scaleFactor), argCLong (coerce displayGamut), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr name $ \raw_name ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
      withObjCPtr error_ $ \raw_error_ ->
          fmap (RawId . castPtr) $ sendMsg mtkTextureLoader (mkSelector "newTextureWithName:scaleFactor:bundle:options:error:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argCDouble (fromIntegral scaleFactor), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_error_ :: Ptr ())]
...
withObjCPtr name $ \raw_name ->
  withObjCPtr bundle $ \raw_bundle ->
    withObjCPtr options $ \raw_options ->
      withObjCPtr error_ $ \raw_error_ ->
          fmap (RawId . castPtr) $ sendMsg mtkTextureLoader (mkSelector "newTextureWithName:scaleFactor:displayGamut:bundle:options:error:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argCDouble (fromIntegral scaleFactor), argCLong (coerce displayGamut), argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_error_ :: Ptr ())]
