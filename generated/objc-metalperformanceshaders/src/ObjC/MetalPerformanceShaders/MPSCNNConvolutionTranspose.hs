...
setKernelOffsetX mpscnnConvolutionTranspose  value =
  sendMsg mpscnnConvolutionTranspose (mkSelector "setKernelOffsetX:") retVoid [argCLong (fromIntegral value)]
...
setKernelOffsetY mpscnnConvolutionTranspose  value =
  sendMsg mpscnnConvolutionTranspose (mkSelector "setKernelOffsetY:") retVoid [argCLong (fromIntegral value)]
