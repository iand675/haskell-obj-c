...
setKernelOffsetX mpscnnGradientKernel  value =
  sendMsg mpscnnGradientKernel (mkSelector "setKernelOffsetX:") retVoid [argCLong (fromIntegral value)]
...
setKernelOffsetY mpscnnGradientKernel  value =
  sendMsg mpscnnGradientKernel (mkSelector "setKernelOffsetY:") retVoid [argCLong (fromIntegral value)]
