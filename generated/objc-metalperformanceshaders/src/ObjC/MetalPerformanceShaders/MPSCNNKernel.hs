...
setDestinationFeatureChannelOffset mpscnnKernel  value =
  sendMsg mpscnnKernel (mkSelector "setDestinationFeatureChannelOffset:") retVoid [argCULong (fromIntegral value)]
...
setSourceFeatureChannelOffset mpscnnKernel  value =
  sendMsg mpscnnKernel (mkSelector "setSourceFeatureChannelOffset:") retVoid [argCULong (fromIntegral value)]
...
setSourceFeatureChannelMaxCount mpscnnKernel  value =
  sendMsg mpscnnKernel (mkSelector "setSourceFeatureChannelMaxCount:") retVoid [argCULong (fromIntegral value)]
