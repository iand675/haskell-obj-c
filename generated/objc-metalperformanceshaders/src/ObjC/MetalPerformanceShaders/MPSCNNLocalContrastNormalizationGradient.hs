...
initWithDevice_kernelWidth_kernelHeight mpscnnLocalContrastNormalizationGradient  device kernelWidth kernelHeight =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "initWithDevice:kernelWidth:kernelHeight:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong (fromIntegral kernelWidth), argCULong (fromIntegral kernelHeight)] >>= ownedObject . castPtr
...
setAlpha mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setAlpha:") retVoid [argCFloat (fromIntegral value)]
...
setBeta mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setBeta:") retVoid [argCFloat (fromIntegral value)]
...
setDelta mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setDelta:") retVoid [argCFloat (fromIntegral value)]
...
setP0 mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setP0:") retVoid [argCFloat (fromIntegral value)]
...
setPm mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setPm:") retVoid [argCFloat (fromIntegral value)]
...
setPs mpscnnLocalContrastNormalizationGradient  value =
  sendMsg mpscnnLocalContrastNormalizationGradient (mkSelector "setPs:") retVoid [argCFloat (fromIntegral value)]
