...
initWithDevice_sourceCount mpscnnMultiaryKernel  device sourceCount =
  sendMsg mpscnnMultiaryKernel (mkSelector "initWithDevice:sourceCount:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong (fromIntegral sourceCount)] >>= ownedObject . castPtr
...
sourceFeatureChannelOffsetAtIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "sourceFeatureChannelOffsetAtIndex:") retCULong [argCULong (fromIntegral index)]
...
setSourceFeatureChannelOffset_atIndex mpscnnMultiaryKernel  offset index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setSourceFeatureChannelOffset:atIndex:") retVoid [argCULong (fromIntegral offset), argCULong (fromIntegral index)]
...
sourceFeatureChannelMaxCountAtIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "sourceFeatureChannelMaxCountAtIndex:") retCULong [argCULong (fromIntegral index)]
...
setSourceFeatureChannelMaxCount_atIndex mpscnnMultiaryKernel  count index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setSourceFeatureChannelMaxCount:atIndex:") retVoid [argCULong (fromIntegral count), argCULong (fromIntegral index)]
...
edgeModeAtIndex mpscnnMultiaryKernel  index =
  fmap (coerce :: CULong -> MPSImageEdgeMode) $ sendMsg mpscnnMultiaryKernel (mkSelector "edgeModeAtIndex:") retCULong [argCULong (fromIntegral index)]
...
setEdgeMode_atIndex mpscnnMultiaryKernel  edgeMode index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setEdgeMode:atIndex:") retVoid [argCULong (coerce edgeMode), argCULong (fromIntegral index)]
...
kernelWidthAtIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "kernelWidthAtIndex:") retCULong [argCULong (fromIntegral index)]
...
setKernelWidth_atIndex mpscnnMultiaryKernel  width index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setKernelWidth:atIndex:") retVoid [argCULong (fromIntegral width), argCULong (fromIntegral index)]
...
kernelHeightAtIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "kernelHeightAtIndex:") retCULong [argCULong (fromIntegral index)]
...
setKernelHeight_atIndex mpscnnMultiaryKernel  height index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setKernelHeight:atIndex:") retVoid [argCULong (fromIntegral height), argCULong (fromIntegral index)]
...
strideInPixelsXatIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "strideInPixelsXatIndex:") retCULong [argCULong (fromIntegral index)]
...
setStrideInPixelsX_atIndex mpscnnMultiaryKernel  stride index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setStrideInPixelsX:atIndex:") retVoid [argCULong (fromIntegral stride), argCULong (fromIntegral index)]
...
strideInPixelsYatIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "strideInPixelsYatIndex:") retCULong [argCULong (fromIntegral index)]
...
setStrideInPixelsY_atIndex mpscnnMultiaryKernel  stride index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setStrideInPixelsY:atIndex:") retVoid [argCULong (fromIntegral stride), argCULong (fromIntegral index)]
...
dilationRateXatIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "dilationRateXatIndex:") retCULong [argCULong (fromIntegral index)]
...
setDilationRateX_atIndex mpscnnMultiaryKernel  dilationRate index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setDilationRateX:atIndex:") retVoid [argCULong (fromIntegral dilationRate), argCULong (fromIntegral index)]
...
dilationRateYatIndex mpscnnMultiaryKernel  index =
  sendMsg mpscnnMultiaryKernel (mkSelector "dilationRateYatIndex:") retCULong [argCULong (fromIntegral index)]
...
setDilationRateY_atIndex mpscnnMultiaryKernel  dilationRate index =
  sendMsg mpscnnMultiaryKernel (mkSelector "setDilationRateY:atIndex:") retVoid [argCULong (fromIntegral dilationRate), argCULong (fromIntegral index)]
...
setDestinationFeatureChannelOffset mpscnnMultiaryKernel  value =
  sendMsg mpscnnMultiaryKernel (mkSelector "setDestinationFeatureChannelOffset:") retVoid [argCULong (fromIntegral value)]
