...
withObjCPtr sourceNode $ \raw_sourceNode ->
    sendMsg mpscnnNeuronHardSigmoidNode (mkSelector "initWithSource:a:b:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat (fromIntegral a), argCFloat (fromIntegral b)] >>= ownedObject . castPtr
...
withObjCPtr sourceNode $ \raw_sourceNode ->
    sendMsg mpscnnNeuronHardSigmoidNode (mkSelector "initWithSource:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ())] >>= ownedObject . castPtr
