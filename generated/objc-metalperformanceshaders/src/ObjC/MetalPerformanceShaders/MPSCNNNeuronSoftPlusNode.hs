...
withObjCPtr sourceNode $ \raw_sourceNode ->
    sendMsg mpscnnNeuronSoftPlusNode (mkSelector "initWithSource:a:b:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat (fromIntegral a), argCFloat (fromIntegral b)] >>= ownedObject . castPtr
...
withObjCPtr sourceNode $ \raw_sourceNode ->
    sendMsg mpscnnNeuronSoftPlusNode (mkSelector "initWithSource:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ())] >>= ownedObject . castPtr
