...
setZeroPadSizeX mpscnnPoolingAverageGradient  value =
  sendMsg mpscnnPoolingAverageGradient (mkSelector "setZeroPadSizeX:") retVoid [argCULong (fromIntegral value)]
...
setZeroPadSizeY mpscnnPoolingAverageGradient  value =
  sendMsg mpscnnPoolingAverageGradient (mkSelector "setZeroPadSizeY:") retVoid [argCULong (fromIntegral value)]
