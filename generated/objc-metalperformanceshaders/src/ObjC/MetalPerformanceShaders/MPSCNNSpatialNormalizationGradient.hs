...
initWithDevice_kernelWidth_kernelHeight mpscnnSpatialNormalizationGradient  device kernelWidth kernelHeight =
  sendMsg mpscnnSpatialNormalizationGradient (mkSelector "initWithDevice:kernelWidth:kernelHeight:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong (fromIntegral kernelWidth), argCULong (fromIntegral kernelHeight)] >>= ownedObject . castPtr
...
setAlpha mpscnnSpatialNormalizationGradient  value =
  sendMsg mpscnnSpatialNormalizationGradient (mkSelector "setAlpha:") retVoid [argCFloat (fromIntegral value)]
...
setBeta mpscnnSpatialNormalizationGradient  value =
  sendMsg mpscnnSpatialNormalizationGradient (mkSelector "setBeta:") retVoid [argCFloat (fromIntegral value)]
...
setDelta mpscnnSpatialNormalizationGradient  value =
  sendMsg mpscnnSpatialNormalizationGradient (mkSelector "setDelta:") retVoid [argCFloat (fromIntegral value)]
