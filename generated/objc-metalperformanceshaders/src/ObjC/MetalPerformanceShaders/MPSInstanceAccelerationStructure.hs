...
setInstanceBufferOffset mpsInstanceAccelerationStructure  value =
  sendMsg mpsInstanceAccelerationStructure (mkSelector "setInstanceBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setTransformBufferOffset mpsInstanceAccelerationStructure  value =
  sendMsg mpsInstanceAccelerationStructure (mkSelector "setTransformBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setMaskBufferOffset mpsInstanceAccelerationStructure  value =
  sendMsg mpsInstanceAccelerationStructure (mkSelector "setMaskBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setInstanceCount mpsInstanceAccelerationStructure  value =
  sendMsg mpsInstanceAccelerationStructure (mkSelector "setInstanceCount:") retVoid [argCULong (fromIntegral value)]
