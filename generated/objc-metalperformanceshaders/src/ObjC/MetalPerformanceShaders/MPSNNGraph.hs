...
readCountForSourceImageAtIndex mpsnnGraph  index =
  sendMsg mpsnnGraph (mkSelector "readCountForSourceImageAtIndex:") retCULong [argCULong (fromIntegral index)]
...
readCountForSourceStateAtIndex mpsnnGraph  index =
  sendMsg mpsnnGraph (mkSelector "readCountForSourceStateAtIndex:") retCULong [argCULong (fromIntegral index)]
