...
initWithDevice mpsnnReduceColumnSum  device =
  sendMsg mpsnnReduceColumnSum (mkSelector "initWithDevice:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr aDecoder $ \raw_aDecoder ->
    sendMsg mpsnnReduceColumnSum (mkSelector "initWithCoder:device:") (retPtr retVoid) [argPtr (castPtr raw_aDecoder :: Ptr ()), argPtr (castPtr (unRawId device) :: Ptr ())] >>= ownedObject . castPtr
