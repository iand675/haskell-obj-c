...
setVertexStride mpsPolygonAccelerationStructure  value =
  sendMsg mpsPolygonAccelerationStructure (mkSelector "setVertexStride:") retVoid [argCULong (fromIntegral value)]
...
setVertexBufferOffset mpsPolygonAccelerationStructure  value =
  sendMsg mpsPolygonAccelerationStructure (mkSelector "setVertexBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setIndexBufferOffset mpsPolygonAccelerationStructure  value =
  sendMsg mpsPolygonAccelerationStructure (mkSelector "setIndexBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setMaskBufferOffset mpsPolygonAccelerationStructure  value =
  sendMsg mpsPolygonAccelerationStructure (mkSelector "setMaskBufferOffset:") retVoid [argCULong (fromIntegral value)]
...
setPolygonCount mpsPolygonAccelerationStructure  value =
  sendMsg mpsPolygonAccelerationStructure (mkSelector "setPolygonCount:") retVoid [argCULong (fromIntegral value)]
