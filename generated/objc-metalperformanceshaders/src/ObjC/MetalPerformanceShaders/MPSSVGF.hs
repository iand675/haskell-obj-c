...
setDepthWeight mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setDepthWeight:") retVoid [argCFloat (fromIntegral value)]
...
setNormalWeight mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setNormalWeight:") retVoid [argCFloat (fromIntegral value)]
...
setLuminanceWeight mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setLuminanceWeight:") retVoid [argCFloat (fromIntegral value)]
...
setTemporalReprojectionBlendFactor mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setTemporalReprojectionBlendFactor:") retVoid [argCFloat (fromIntegral value)]
...
setReprojectionThreshold mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setReprojectionThreshold:") retVoid [argCFloat (fromIntegral value)]
...
setMinimumFramesForVarianceEstimation mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setMinimumFramesForVarianceEstimation:") retVoid [argCULong (fromIntegral value)]
...
setVarianceEstimationRadius mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setVarianceEstimationRadius:") retVoid [argCULong (fromIntegral value)]
...
setVarianceEstimationSigma mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setVarianceEstimationSigma:") retVoid [argCFloat (fromIntegral value)]
...
setVariancePrefilterSigma mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setVariancePrefilterSigma:") retVoid [argCFloat (fromIntegral value)]
...
setVariancePrefilterRadius mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setVariancePrefilterRadius:") retVoid [argCULong (fromIntegral value)]
...
setBilateralFilterSigma mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setBilateralFilterSigma:") retVoid [argCFloat (fromIntegral value)]
...
setBilateralFilterRadius mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setBilateralFilterRadius:") retVoid [argCULong (fromIntegral value)]
...
setChannelCount mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setChannelCount:") retVoid [argCULong (fromIntegral value)]
...
setChannelCount2 mpssvgf  value =
  sendMsg mpssvgf (mkSelector "setChannelCount2:") retVoid [argCULong (fromIntegral value)]
