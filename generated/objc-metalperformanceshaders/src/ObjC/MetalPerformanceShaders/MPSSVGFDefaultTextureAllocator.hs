...
textureWithPixelFormat_width_height mpssvgfDefaultTextureAllocator  pixelFormat width height =
  fmap (RawId . castPtr) $ sendMsg mpssvgfDefaultTextureAllocator (mkSelector "textureWithPixelFormat:width:height:") (retPtr retVoid) [argCULong (coerce pixelFormat), argCULong (fromIntegral width), argCULong (fromIntegral height)]
