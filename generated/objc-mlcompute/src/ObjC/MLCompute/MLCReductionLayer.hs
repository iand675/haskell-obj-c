...
layerWithReductionType_dimension reductionType dimension =
  do
    ...
    sendClassMsg cls' (mkSelector "layerWithReductionType:dimension:") (retPtr retVoid) [argCInt (coerce reductionType), argCULong (fromIntegral dimension)] >>= retainedObject . castPtr
