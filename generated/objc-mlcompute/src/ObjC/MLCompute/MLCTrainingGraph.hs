...
withObjCPtr inputsData $ \raw_inputsData ->
  withObjCPtr lossLabelsData $ \raw_lossLabelsData ->
    withObjCPtr lossLabelWeightsData $ \raw_lossLabelWeightsData ->
        fmap ((/= 0) :: CULong -> Bool) $ sendMsg mlcTrainingGraph (mkSelector "executeWithInputsData:lossLabelsData:lossLabelWeightsData:batchSize:options:completionHandler:") retCULong [argPtr (castPtr raw_inputsData :: Ptr ()), argPtr (castPtr raw_lossLabelsData :: Ptr ()), argPtr (castPtr raw_lossLabelWeightsData :: Ptr ()), argCULong (fromIntegral batchSize), argCULong (coerce options), argPtr (castPtr completionHandler :: Ptr ())]
...
executeForwardWithBatchSize_options_completionHandler mlcTrainingGraph  batchSize options completionHandler =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg mlcTrainingGraph (mkSelector "executeForwardWithBatchSize:options:completionHandler:") retCULong [argCULong (fromIntegral batchSize), argCULong (coerce options), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr outputsData $ \raw_outputsData ->
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg mlcTrainingGraph (mkSelector "executeForwardWithBatchSize:options:outputsData:completionHandler:") retCULong [argCULong (fromIntegral batchSize), argCULong (coerce options), argPtr (castPtr raw_outputsData :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
executeGradientWithBatchSize_options_completionHandler mlcTrainingGraph  batchSize options completionHandler =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg mlcTrainingGraph (mkSelector "executeGradientWithBatchSize:options:completionHandler:") retCULong [argCULong (fromIntegral batchSize), argCULong (coerce options), argPtr (castPtr completionHandler :: Ptr ())]
...
withObjCPtr outputsData $ \raw_outputsData ->
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg mlcTrainingGraph (mkSelector "executeGradientWithBatchSize:options:outputsData:completionHandler:") retCULong [argCULong (fromIntegral batchSize), argCULong (coerce options), argPtr (castPtr raw_outputsData :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
