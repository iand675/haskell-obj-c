...
withObjCPtr descriptor $ \raw_descriptor ->
  withObjCPtr submeshes $ \raw_submeshes ->
      sendMsg mdlMesh (mkSelector "initWithVertexBuffer:vertexCount:descriptor:submeshes:") (retPtr retVoid) [argPtr (castPtr (unRawId vertexBuffer) :: Ptr ()), argCULong (fromIntegral vertexCount), argPtr (castPtr raw_descriptor :: Ptr ()), argPtr (castPtr raw_submeshes :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr vertexBuffers $ \raw_vertexBuffers ->
  withObjCPtr descriptor $ \raw_descriptor ->
    withObjCPtr submeshes $ \raw_submeshes ->
        sendMsg mdlMesh (mkSelector "initWithVertexBuffers:vertexCount:descriptor:submeshes:") (retPtr retVoid) [argPtr (castPtr raw_vertexBuffers :: Ptr ()), argCULong (fromIntegral vertexCount), argPtr (castPtr raw_descriptor :: Ptr ()), argPtr (castPtr raw_submeshes :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr objectsToConsider $ \raw_objectsToConsider ->
  withObjCPtr vertexAttributeName $ \raw_vertexAttributeName ->
    withObjCPtr materialPropertyName $ \raw_materialPropertyName ->
        fmap ((/= 0) :: CULong -> Bool) $ sendMsg mdlMesh (mkSelector "generateAmbientOcclusionTextureWithQuality:attenuationFactor:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:") retCULong [argCFloat (fromIntegral bakeQuality), argCFloat (fromIntegral attenuationFactor), argPtr (castPtr raw_objectsToConsider :: Ptr ()), argPtr (castPtr raw_vertexAttributeName :: Ptr ()), argPtr (castPtr raw_materialPropertyName :: Ptr ())]
...
withObjCPtr objectsToConsider $ \raw_objectsToConsider ->
  withObjCPtr vertexAttributeName $ \raw_vertexAttributeName ->
      fmap ((/= 0) :: CULong -> Bool) $ sendMsg mdlMesh (mkSelector "generateAmbientOcclusionVertexColorsWithQuality:attenuationFactor:objectsToConsider:vertexAttributeNamed:") retCULong [argCFloat (fromIntegral bakeQuality), argCFloat (fromIntegral attenuationFactor), argPtr (castPtr raw_objectsToConsider :: Ptr ()), argPtr (castPtr raw_vertexAttributeName :: Ptr ())]
...
withObjCPtr lightsToConsider $ \raw_lightsToConsider ->
  withObjCPtr objectsToConsider $ \raw_objectsToConsider ->
    withObjCPtr vertexAttributeName $ \raw_vertexAttributeName ->
      withObjCPtr materialPropertyName $ \raw_materialPropertyName ->
          fmap ((/= 0) :: CULong -> Bool) $ sendMsg mdlMesh (mkSelector "generateLightMapTextureWithQuality:lightsToConsider:objectsToConsider:vertexAttributeNamed:materialPropertyNamed:") retCULong [argCFloat (fromIntegral bakeQuality), argPtr (castPtr raw_lightsToConsider :: Ptr ()), argPtr (castPtr raw_objectsToConsider :: Ptr ()), argPtr (castPtr raw_vertexAttributeName :: Ptr ()), argPtr (castPtr raw_materialPropertyName :: Ptr ())]
...
withObjCPtr mesh $ \raw_mesh ->
    sendMsg mdlMesh (mkSelector "initMeshBySubdividingMesh:submeshIndex:subdivisionLevels:allocator:") (retPtr retVoid) [argPtr (castPtr raw_mesh :: Ptr ()), argCInt (fromIntegral submeshIndex), argCUInt (fromIntegral subdivisionLevels), argPtr (castPtr (unRawId allocator) :: Ptr ())] >>= ownedObject . castPtr
...
newIcosahedronWithRadius_inwardNormals_geometryType_allocator radius inwardNormals geometryType allocator =
  do
    ...
    sendClassMsg cls' (mkSelector "newIcosahedronWithRadius:inwardNormals:geometryType:allocator:") (retPtr retVoid) [argCFloat (fromIntegral radius), argCULong (if inwardNormals then 1 else 0), argCLong (coerce geometryType), argPtr (castPtr (unRawId allocator) :: Ptr ())] >>= ownedObject . castPtr
...
newIcosahedronWithRadius_inwardNormals_allocator radius inwardNormals allocator =
  do
    cls' <- getRequiredClass "MDLMesh"
    sendClassMsg cls' (mkSelector "newIcosahedronWithRadius:inwardNormals:allocator:") (retPtr retVoid) [argCFloat (fromIntegral radius), argCULong (if inwardNormals then 1 else 0), argPtr (castPtr (unRawId allocator) :: Ptr ())] >>= ownedObject . castPtr
...
newSubdividedMesh_submeshIndex_subdivisionLevels mesh submeshIndex subdivisionLevels =
  do
    cls' <- getRequiredClass "MDLMesh"
    withObjCPtr mesh $ \raw_mesh ->
      sendClassMsg cls' (mkSelector "newSubdividedMesh:submeshIndex:subdivisionLevels:") (retPtr retVoid) [argPtr (castPtr raw_mesh :: Ptr ()), argCULong (fromIntegral submeshIndex), argCULong (fromIntegral subdivisionLevels)] >>= ownedObject . castPtr
...
withObjCPtr name $ \raw_name ->
  withObjCPtr type_ $ \raw_type_ ->
    withObjCPtr data_ $ \raw_data_ ->
        sendMsg mdlMesh (mkSelector "addAttributeWithName:format:type:data:stride:") retVoid [argPtr (castPtr raw_name :: Ptr ()), argCULong (coerce format), argPtr (castPtr raw_type_ :: Ptr ()), argPtr (castPtr raw_data_ :: Ptr ()), argCLong (fromIntegral stride)]
...
withObjCPtr name $ \raw_name ->
  withObjCPtr type_ $ \raw_type_ ->
    withObjCPtr data_ $ \raw_data_ ->
        sendMsg mdlMesh (mkSelector "addAttributeWithName:format:type:data:stride:time:") retVoid [argPtr (castPtr raw_name :: Ptr ()), argCULong (coerce format), argPtr (castPtr raw_type_ :: Ptr ()), argPtr (castPtr raw_data_ :: Ptr ()), argCLong (fromIntegral stride), argCDouble (fromIntegral time)]
...
withObjCPtr attributeName $ \raw_attributeName ->
    sendMsg mdlMesh (mkSelector "addNormalsWithAttributeNamed:creaseThreshold:") retVoid [argPtr (castPtr raw_attributeName :: Ptr ()), argCFloat (fromIntegral creaseThreshold)]
...
setVertexCount mdlMesh  value =
  sendMsg mdlMesh (mkSelector "setVertexCount:") retVoid [argCULong (fromIntegral value)]
