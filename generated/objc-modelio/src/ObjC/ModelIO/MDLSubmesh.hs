...
withObjCPtr name $ \raw_name ->
  withObjCPtr material $ \raw_material ->
      sendMsg mdlSubmesh (mkSelector "initWithName:indexBuffer:indexCount:indexType:geometryType:material:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argPtr (castPtr (unRawId indexBuffer) :: Ptr ()), argCULong (fromIntegral indexCount), argCULong (coerce indexType), argCLong (coerce geometryType), argPtr (castPtr raw_material :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr material $ \raw_material ->
    sendMsg mdlSubmesh (mkSelector "initWithIndexBuffer:indexCount:indexType:geometryType:material:") (retPtr retVoid) [argPtr (castPtr (unRawId indexBuffer) :: Ptr ()), argCULong (fromIntegral indexCount), argCULong (coerce indexType), argCLong (coerce geometryType), argPtr (castPtr raw_material :: Ptr ())] >>= ownedObject . castPtr
...
withObjCPtr name $ \raw_name ->
  withObjCPtr material $ \raw_material ->
    withObjCPtr topology $ \raw_topology ->
        sendMsg mdlSubmesh (mkSelector "initWithName:indexBuffer:indexCount:indexType:geometryType:material:topology:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argPtr (castPtr (unRawId indexBuffer) :: Ptr ()), argCULong (fromIntegral indexCount), argCULong (coerce indexType), argCLong (coerce geometryType), argPtr (castPtr raw_material :: Ptr ()), argPtr (castPtr raw_topology :: Ptr ())] >>= ownedObject . castPtr
