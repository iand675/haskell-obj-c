...
name mdlTransformOrientOp  =
  sendMsg mdlTransformOrientOp (mkSelector "name") (retPtr retVoid) [] >>= retainedObject . castPtr
...
animatedValue mdlTransformOrientOp  =
  sendMsg mdlTransformOrientOp (mkSelector "animatedValue") (retPtr retVoid) [] >>= retainedObject . castPtr
