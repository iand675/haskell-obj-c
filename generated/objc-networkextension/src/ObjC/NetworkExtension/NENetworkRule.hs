...
withObjCPtr networkEndpoint $ \raw_networkEndpoint ->
    sendMsg neNetworkRule (mkSelector "initWithDestinationNetworkEndpoint:prefix:protocol:") (retPtr retVoid) [argPtr (castPtr raw_networkEndpoint :: Ptr ()), argCULong (fromIntegral destinationPrefix), argCLong (coerce protocol)] >>= ownedObject . castPtr
...
withObjCPtr networkEndpoint $ \raw_networkEndpoint ->
    sendMsg neNetworkRule (mkSelector "initWithDestinationNetwork:prefix:protocol:") (retPtr retVoid) [argPtr (castPtr raw_networkEndpoint :: Ptr ()), argCULong (fromIntegral destinationPrefix), argCLong (coerce protocol)] >>= ownedObject . castPtr
...
withObjCPtr remoteNetwork $ \raw_remoteNetwork ->
  withObjCPtr localNetwork $ \raw_localNetwork ->
      sendMsg neNetworkRule (mkSelector "initWithRemoteNetworkEndpoint:remotePrefix:localNetworkEndpoint:localPrefix:protocol:direction:") (retPtr retVoid) [argPtr (castPtr raw_remoteNetwork :: Ptr ()), argCULong (fromIntegral remotePrefix), argPtr (castPtr raw_localNetwork :: Ptr ()), argCULong (fromIntegral localPrefix), argCLong (coerce protocol), argCLong (coerce direction)] >>= ownedObject . castPtr
