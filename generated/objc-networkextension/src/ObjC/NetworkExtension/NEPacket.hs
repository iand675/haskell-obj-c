...
withObjCPtr data_ $ \raw_data_ ->
    sendMsg nePacket (mkSelector "initWithData:protocolFamily:") (retPtr retVoid) [argPtr (castPtr raw_data_ :: Ptr ()), argCUChar (fromIntegral protocolFamily)] >>= ownedObject . castPtr
