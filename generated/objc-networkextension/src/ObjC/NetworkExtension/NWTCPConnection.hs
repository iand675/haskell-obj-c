...
readLength_completionHandler nwtcpConnection  length_ completion =
  sendMsg nwtcpConnection (mkSelector "readLength:completionHandler:") retVoid [argCULong (fromIntegral length_), argPtr (castPtr completion :: Ptr ())]
...
readMinimumLength_maximumLength_completionHandler nwtcpConnection  minimum_ maximum_ completion =
  sendMsg nwtcpConnection (mkSelector "readMinimumLength:maximumLength:completionHandler:") retVoid [argCULong (fromIntegral minimum_), argCULong (fromIntegral maximum_), argPtr (castPtr completion :: Ptr ())]
