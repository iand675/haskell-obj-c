...
willPasswordExpire odRecord  willExpireIn =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg odRecord (mkSelector "willPasswordExpire:") retCULong [argCULong (fromIntegral willExpireIn)]
...
willAuthenticationsExpire odRecord  willExpireIn =
  fmap ((/= 0) :: CULong -> Bool) $ sendMsg odRecord (mkSelector "willAuthenticationsExpire:") retCULong [argCULong (fromIntegral willExpireIn)]
