...
withObjCPtr type_ $ \raw_type_ ->
  withObjCPtr color $ \raw_color ->
      sendMsg pkInkingTool (mkSelector "initWithInkType:color:width:") (retPtr retVoid) [argPtr (castPtr raw_type_ :: Ptr ()), argPtr (castPtr raw_color :: Ptr ()), argCDouble (fromIntegral width)] >>= ownedObject . castPtr
...
withObjCPtr type_ $ \raw_type_ ->
  withObjCPtr color $ \raw_color ->
      sendMsg pkInkingTool (mkSelector "initWithInkType:color:width:azimuth:") (retPtr retVoid) [argPtr (castPtr raw_type_ :: Ptr ()), argPtr (castPtr raw_color :: Ptr ()), argCDouble (fromIntegral width), argCDouble (fromIntegral angle)] >>= ownedObject . castPtr
...
withObjCPtr ink $ \raw_ink ->
    sendMsg pkInkingTool (mkSelector "initWithInk:width:") (retPtr retVoid) [argPtr (castPtr raw_ink :: Ptr ()), argCDouble (fromIntegral width)] >>= ownedObject . castPtr
