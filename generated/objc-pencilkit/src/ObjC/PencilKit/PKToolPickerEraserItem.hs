...
initWithEraserType_width pkToolPickerEraserItem  eraserType width =
  sendMsg pkToolPickerEraserItem (mkSelector "initWithEraserType:width:") (retPtr retVoid) [argCLong (coerce eraserType), argCDouble (fromIntegral width)] >>= ownedObject . castPtr
