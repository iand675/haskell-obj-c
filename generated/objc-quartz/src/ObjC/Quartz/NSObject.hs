...
withObjCPtr aBrowser $ \raw_aBrowser ->
    sendMsg nsObject (mkSelector "imageBrowser:cellWasDoubleClickedAtIndex:") retVoid [argPtr (castPtr raw_aBrowser :: Ptr ()), argCULong (fromIntegral index)]
...
imageBrowser_cellWasRightClickedAtIndex_withEvent :: (IsNSObject nsObject, IsIKImageBrowserView aBrowser, IsNSEvent event) => nsObject -> aBrowser -> CULong -> event -> IO ()
imageBrowser_cellWasRightClickedAtIndex_withEvent nsObject  aBrowser index event =
withObjCPtr aBrowser $ \raw_aBrowser ->
  withObjCPtr event $ \raw_event ->
      sendMsg nsObject (mkSelector "imageBrowser:cellWasRightClickedAtIndex:withEvent:") retVoid [argPtr (castPtr raw_aBrowser :: Ptr ()), argCULong (fromIntegral index), argPtr (castPtr raw_event :: Ptr ())]
...
imageBrowser_backgroundWasRightClickedWithEvent :: (IsNSObject nsObject, IsIKImageBrowserView aBrowser, IsNSEvent event) => nsObject -> aBrowser -> event -> IO ()
imageBrowser_backgroundWasRightClickedWithEvent nsObject  aBrowser event =
withObjCPtr aBrowser $ \raw_aBrowser ->
  withObjCPtr event $ \raw_event ->
      sendMsg nsObject (mkSelector "imageBrowser:backgroundWasRightClickedWithEvent:") retVoid [argPtr (castPtr raw_aBrowser :: Ptr ()), argPtr (castPtr raw_event :: Ptr ())]
...
withObjCPtr aBrowser $ \raw_aBrowser ->
    fmap (RawId . castPtr) $ sendMsg nsObject (mkSelector "imageBrowser:itemAtIndex:") (retPtr retVoid) [argPtr (castPtr raw_aBrowser :: Ptr ()), argCULong (fromIntegral index)]
...
withObjCPtr aBrowser $ \raw_aBrowser ->
  withObjCPtr indexes $ \raw_indexes ->
      fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsObject (mkSelector "imageBrowser:moveItemsAtIndexes:toIndex:") retCULong [argPtr (castPtr raw_aBrowser :: Ptr ()), argPtr (castPtr raw_indexes :: Ptr ()), argCULong (fromIntegral destinationIndex)]
...
imageBrowser_writeItemsAtIndexes_toPasteboard :: (IsNSObject nsObject, IsIKImageBrowserView aBrowser, IsNSIndexSet itemIndexes, IsNSPasteboard pasteboard) => nsObject -> aBrowser -> itemIndexes -> pasteboard -> IO CULong
...
withObjCPtr aBrowser $ \raw_aBrowser ->
  withObjCPtr itemIndexes $ \raw_itemIndexes ->
    withObjCPtr pasteboard $ \raw_pasteboard ->
        sendMsg nsObject (mkSelector "imageBrowser:writeItemsAtIndexes:toPasteboard:") retCULong [argPtr (castPtr raw_aBrowser :: Ptr ()), argPtr (castPtr raw_itemIndexes :: Ptr ()), argPtr (castPtr raw_pasteboard :: Ptr ())]
...
withObjCPtr aBrowser $ \raw_aBrowser ->
    sendMsg nsObject (mkSelector "imageBrowser:groupAtIndex:") (retPtr retVoid) [argPtr (castPtr raw_aBrowser :: Ptr ()), argCULong (fromIntegral index)] >>= retainedObject . castPtr
