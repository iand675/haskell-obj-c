...
withObjCPtr layer $ \raw_layer ->
    sendMsg caLayer (mkSelector "insertSublayer:atIndex:") retVoid [argPtr (castPtr raw_layer :: Ptr ()), argCUInt (fromIntegral idx)]
...
withObjCPtr l $ \raw_l ->
    sendMsg caLayer (mkSelector "convertTime:fromLayer:") retCDouble [argCDouble (fromIntegral t), argPtr (castPtr raw_l :: Ptr ())]

-- | @- convertTime:toLayer:@
convertTime_toLayer :: (IsCALayer caLayer, IsCALayer l) => caLayer -> CDouble -> l -> IO CDouble
convertTime_toLayer caLayer  t l =
withObjCPtr l $ \raw_l ->
    sendMsg caLayer (mkSelector "convertTime:toLayer:") retCDouble [argCDouble (fromIntegral t), argPtr (castPtr raw_l :: Ptr ())]
...
layerWithRemoteClientId client_id =
  do
    cls' <- getRequiredClass "CALayer"
    sendClassMsg cls' (mkSelector "layerWithRemoteClientId:") (retPtr retVoid) [argCUInt (fromIntegral client_id)] >>= retainedObject . castPtr
...
setZPosition caLayer  value =
  sendMsg caLayer (mkSelector "setZPosition:") retVoid [argCDouble (fromIntegral value)]
...
setAnchorPointZ caLayer  value =
  sendMsg caLayer (mkSelector "setAnchorPointZ:") retVoid [argCDouble (fromIntegral value)]
...
setContentsScale caLayer  value =
  sendMsg caLayer (mkSelector "setContentsScale:") retVoid [argCDouble (fromIntegral value)]
...
setContentsHeadroom caLayer  value =
  sendMsg caLayer (mkSelector "setContentsHeadroom:") retVoid [argCDouble (fromIntegral value)]
...
setMinificationFilterBias caLayer  value =
  sendMsg caLayer (mkSelector "setMinificationFilterBias:") retVoid [argCFloat (fromIntegral value)]
...
setCornerRadius caLayer  value =
  sendMsg caLayer (mkSelector "setCornerRadius:") retVoid [argCDouble (fromIntegral value)]
...
setBorderWidth caLayer  value =
  sendMsg caLayer (mkSelector "setBorderWidth:") retVoid [argCDouble (fromIntegral value)]
...
setOpacity caLayer  value =
  sendMsg caLayer (mkSelector "setOpacity:") retVoid [argCFloat (fromIntegral value)]
...
setRasterizationScale caLayer  value =
  sendMsg caLayer (mkSelector "setRasterizationScale:") retVoid [argCDouble (fromIntegral value)]
...
setShadowOpacity caLayer  value =
  sendMsg caLayer (mkSelector "setShadowOpacity:") retVoid [argCFloat (fromIntegral value)]
...
setShadowRadius caLayer  value =
  sendMsg caLayer (mkSelector "setShadowRadius:") retVoid [argCDouble (fromIntegral value)]
