...
-- | @- pixelFormat@
pixelFormat :: IsCAMetalLayer caMetalLayer => caMetalLayer -> IO MTLPixelFormat
pixelFormat caMetalLayer  =
  fmap (coerce :: CULong -> MTLPixelFormat) $ sendMsg caMetalLayer (mkSelector "pixelFormat") retCULong []

-- | @- setPixelFormat:@
setPixelFormat :: IsCAMetalLayer caMetalLayer => caMetalLayer -> MTLPixelFormat -> IO ()
setPixelFormat caMetalLayer  value =
  sendMsg caMetalLayer (mkSelector "setPixelFormat:") retVoid [argCULong (coerce value)]
...
setMaximumDrawableCount caMetalLayer  value =
  sendMsg caMetalLayer (mkSelector "setMaximumDrawableCount:") retVoid [argCULong (fromIntegral value)]
