...
withObjCPtr url $ \raw_url ->
    sendMsg rpScreenRecorder (mkSelector "exportClipToURL:duration:completionHandler:") retVoid [argPtr (castPtr raw_url :: Ptr ()), argCDouble (fromIntegral duration), argPtr (castPtr completionHandler :: Ptr ())]
