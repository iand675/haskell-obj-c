...
translateInCameraSpaceByX_Y_Z scnCameraController  deltaX deltaY deltaZ =
  sendMsg scnCameraController (mkSelector "translateInCameraSpaceByX:Y:Z:") retVoid [argCFloat (fromIntegral deltaX), argCFloat (fromIntegral deltaY), argCFloat (fromIntegral deltaZ)]
...
rotateByX_Y scnCameraController  deltaX deltaY =
  sendMsg scnCameraController (mkSelector "rotateByX:Y:") retVoid [argCFloat (fromIntegral deltaX), argCFloat (fromIntegral deltaY)]
...
rollAroundTarget scnCameraController  delta =
  sendMsg scnCameraController (mkSelector "rollAroundTarget:") retVoid [argCFloat (fromIntegral delta)]
...
dollyToTarget scnCameraController  delta =
  sendMsg scnCameraController (mkSelector "dollyToTarget:") retVoid [argCFloat (fromIntegral delta)]
...
setInertiaFriction scnCameraController  value =
  sendMsg scnCameraController (mkSelector "setInertiaFriction:") retVoid [argCFloat (fromIntegral value)]
...
setMinimumVerticalAngle scnCameraController  value =
  sendMsg scnCameraController (mkSelector "setMinimumVerticalAngle:") retVoid [argCFloat (fromIntegral value)]
...
setMaximumVerticalAngle scnCameraController  value =
  sendMsg scnCameraController (mkSelector "setMaximumVerticalAngle:") retVoid [argCFloat (fromIntegral value)]
...
setMinimumHorizontalAngle scnCameraController  value =
  sendMsg scnCameraController (mkSelector "setMinimumHorizontalAngle:") retVoid [argCFloat (fromIntegral value)]
...
setMaximumHorizontalAngle scnCameraController  value =
  sendMsg scnCameraController (mkSelector "setMaximumHorizontalAngle:") retVoid [argCFloat (fromIntegral value)]
