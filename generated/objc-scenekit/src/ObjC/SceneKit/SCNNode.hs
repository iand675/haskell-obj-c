...
withObjCPtr child $ \raw_child ->
    sendMsg scnNode (mkSelector "insertChildNode:atIndex:") retVoid [argPtr (castPtr raw_child :: Ptr ()), argCULong (fromIntegral index)]
...
setOpacity scnNode  value =
  sendMsg scnNode (mkSelector "setOpacity:") retVoid [argCDouble (fromIntegral value)]
...
setRenderingOrder scnNode  value =
  sendMsg scnNode (mkSelector "setRenderingOrder:") retVoid [argCLong (fromIntegral value)]
...
setCategoryBitMask scnNode  value =
  sendMsg scnNode (mkSelector "setCategoryBitMask:") retVoid [argCULong (fromIntegral value)]
