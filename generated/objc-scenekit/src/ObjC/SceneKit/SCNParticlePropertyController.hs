...
setInputScale scnParticlePropertyController  value =
  sendMsg scnParticlePropertyController (mkSelector "setInputScale:") retVoid [argCDouble (fromIntegral value)]
...
setInputBias scnParticlePropertyController  value =
  sendMsg scnParticlePropertyController (mkSelector "setInputBias:") retVoid [argCDouble (fromIntegral value)]
