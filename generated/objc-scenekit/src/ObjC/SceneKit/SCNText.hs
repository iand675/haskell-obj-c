...
textWithString_extrusionDepth string extrusionDepth =
  do
    ...
    sendClassMsg cls' (mkSelector "textWithString:extrusionDepth:") (retPtr retVoid) [argPtr (castPtr (unRawId string) :: Ptr ()), argCDouble (fromIntegral extrusionDepth)] >>= retainedObject . castPtr
...
setExtrusionDepth scnText  value =
  sendMsg scnText (mkSelector "setExtrusionDepth:") retVoid [argCDouble (fromIntegral value)]
...
setChamferRadius scnText  value =
  sendMsg scnText (mkSelector "setChamferRadius:") retVoid [argCDouble (fromIntegral value)]
...
setChamferSegmentCount scnText  value =
  sendMsg scnText (mkSelector "setChamferSegmentCount:") retVoid [argCLong (fromIntegral value)]
...
setFlatness scnText  value =
  sendMsg scnText (mkSelector "setFlatness:") retVoid [argCDouble (fromIntegral value)]
