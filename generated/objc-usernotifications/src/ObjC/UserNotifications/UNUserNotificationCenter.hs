...
setBadgeCount_withCompletionHandler unUserNotificationCenter  newBadgeCount completionHandler =
  sendMsg unUserNotificationCenter (mkSelector "setBadgeCount:withCompletionHandler:") retVoid [argCLong (fromIntegral newBadgeCount), argPtr (castPtr completionHandler :: Ptr ())]
