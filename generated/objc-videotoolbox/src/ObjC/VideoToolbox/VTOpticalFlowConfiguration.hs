...
initWithFrameWidth_frameHeight_qualityPrioritization_revision vtOpticalFlowConfiguration  frameWidth frameHeight qualityPrioritization revision =
  sendMsg vtOpticalFlowConfiguration (mkSelector "initWithFrameWidth:frameHeight:qualityPrioritization:revision:") (retPtr retVoid) [argCLong (fromIntegral frameWidth), argCLong (fromIntegral frameHeight), argCLong (coerce qualityPrioritization), argCLong (coerce revision)] >>= ownedObject . castPtr
