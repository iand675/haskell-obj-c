...
didMoveTab_fromIndex_inWindow wkWebExtensionController  movedTab index oldWindow =
  sendMsg wkWebExtensionController (mkSelector "didMoveTab:fromIndex:inWindow:") retVoid [argPtr (castPtr (unRawId movedTab) :: Ptr ()), argCULong (fromIntegral index), argPtr (castPtr (unRawId oldWindow) :: Ptr ())]
