...
setMagnification wkWebView  value =
  sendMsg wkWebView (mkSelector "setMagnification:") retVoid [argCDouble (fromIntegral value)]
...
setPageZoom wkWebView  value =
  sendMsg wkWebView (mkSelector "setPageZoom:") retVoid [argCDouble (fromIntegral value)]
